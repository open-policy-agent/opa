...
type refindices struct {
	...
	frequency *util.HashMap[Ref, int]
	sorted    []Ref
}
...
func newrefindices(isVirtual func(Ref) bool) *refindices {
	return &refindices{
		isVirtual: isVirtual,
		rules:     map[*Rule][]*refindex{},
		frequency: util.NewHashMap[Ref, int](func(a, b any) bool {
			r1, r2 := a.(Ref), b.(Ref)
			return r1.Equal(r2)
		}, func(x any) int {
			return x.(Ref).Hash()
...
type trieNode struct {
	...
	any       *trieNode
	undefined *trieNode
	scalars   *util.HashMap[Value, *trieNode]
	array     *trieNode
	rules     []*ruleNode
}
...
func (node *trieNode) String() string {
	...
	if node.scalars.Len() > 0 {
		...
		node.scalars.Iter(func(k Value, v *trieNode) bool {
...
func newTrieNodeImpl() *trieNode {
	return &trieNode{
		scalars: util.NewHashMap[Value, *trieNode](valueEq, valueHash),
	}
}
...
func (node *trieNode) Do(walker trieWalker) {
	...
	node.scalars.Iter(func(_ Value, v *trieNode) bool {
		v.Do(next)
		return false
	})
...
func (node *trieNode) traverseUnknown(resolver ValueResolver, tr *trieTraversalResult) error {
	...
	var iterErr error
	node.scalars.Iter(func(_ Value, v *trieNode) bool {
		if iterErr = v.traverseUnknown(resolver, tr); iterErr != nil {
			return true
		}
		return false
	})
