...
//
// The returned OPA instance expects modules to use the v1 Rego syntax.
func New(ctx context.Context, opts Options) (*OPA, error) {

	var err error

	// Options.V0Compatible and Options.V1Compatible may still override the default rego-version.
