...
// BundleCompiler implements bundle compilation and linking.
...
func (c *BundleCompiler) RegoVersion() ast.RegoVersion {
	return c.regoVersion
}

// WithRevision sets the revision to include in the output bundle manifest.
func (c *BundleCompiler) WithRevision(r string) *BundleCompiler {
	c.revision = &r
	return c
}

// WithAsBundle sets file loading mode on the compiler.
func (c *BundleCompiler) WithAsBundle(enabled bool) *BundleCompiler {
	c.asBundle = enabled
	return c
}
...
func (c *BundleCompiler) WithPruneUnused(enabled bool) *BundleCompiler {
...
func (c *BundleCompiler) WithEntrypoints(e ...string) *BundleCompiler {
...
func (c *BundleCompiler) WithRegoAnnotationEntrypoints(enabled bool) *BundleCompiler {
...
// but can take longer.
func (c *BundleCompiler) WithOptimizationLevel(n int) *BundleCompiler {
	c.optimizationLevel = n
	return c
}

// WithTarget sets the output target type to use.
func (c *BundleCompiler) WithTarget(t string) *BundleCompiler {
	c.target = t
	return c
}

// WithOutput sets the output stream to write the bundle to.
func (c *BundleCompiler) WithOutput(w io.Writer) *BundleCompiler {
	c.output = &w
	return c
}

// WithDebug sets the output stream to write debug info to.
func (c *BundleCompiler) WithDebug(sink io.Writer) *BundleCompiler {
	if sink != nil {
...
func (c *BundleCompiler) WithEnablePrintStatements(yes bool) *BundleCompiler {
	c.enablePrintStatements = yes
	return c
}

// WithPaths adds input filepaths to read policy and data from.
func (c *BundleCompiler) WithPaths(p ...string) *BundleCompiler {
	c.paths = append(c.paths, p...)
	return c
}

// WithFilter sets the loader filter to use when reading non-bundle input files.
func (c *BundleCompiler) WithFilter(filter loader.Filter) *BundleCompiler {
	c.filter = filter
	return c
}
...
// loading options.
func (c *BundleCompiler) WithBundle(b *bundle.Bundle) *BundleCompiler {
	c.bundle = b
	return c
}

// WithBundleVerificationConfig sets the key configuration to use to verify a signed bundle
func (c *BundleCompiler) WithBundleVerificationConfig(config *bundle.VerificationConfig) *BundleCompiler {
	c.bvc = config
	return c
}

// WithBundleSigningConfig sets the key configuration to use to generate a signed bundle
func (c *BundleCompiler) WithBundleSigningConfig(config *bundle.SigningConfig) *BundleCompiler {
	c.bsc = config
	return c
}
...
func (c *BundleCompiler) WithBundleVerificationKeyID(keyID string) *BundleCompiler {
	c.keyID = keyID
	return c
}

// WithCapabilities sets the capabilities to use while checking policies.
func (c *BundleCompiler) WithCapabilities(capabilities *ast.Capabilities) *BundleCompiler {
	c.capabilities = capabilities
	return c
}

// WithFollowSymlinks sets whether or not to follow symlinks in the bundle directory when building the bundle
func (c *BundleCompiler) WithFollowSymlinks(yes bool) *BundleCompiler {
	c.followSymlinks = yes
	return c
}

// WithMetadata sets the additional data to be included in .manifest
func (c *BundleCompiler) WithMetadata(metadata *map[string]interface{}) *BundleCompiler {
	c.metadata = metadata
	return c
}

// WithRoots sets the roots to include in the output bundle manifest.
func (c *BundleCompiler) WithRoots(r ...string) *BundleCompiler {
	c.roots = append(c.roots, r...)
	return c
}

// WithFS sets the file system to use when loading paths
func (c *BundleCompiler) WithFS(fsys fs.FS) *BundleCompiler {
	c.fsys = fsys
	return c
}

// WithPartialNamespace sets the namespace to use for partial evaluation results
func (c *BundleCompiler) WithPartialNamespace(ns string) *BundleCompiler {
	c.ns = ns
	return c
}

func (c *BundleCompiler) WithRegoVersion(v ast.RegoVersion) *BundleCompiler {
	c.regoVersion = v
	return c
}

func addEntrypointsFromAnnotations(c *BundleCompiler, arefs []*ast.AnnotationsRef) error {
...
func (c *BundleCompiler) Build(ctx context.Context) error {

	if c.regoVersion == ast.RegoUndefined {
		// Any public paths to here will have v0 or v1 defined.
		// FIXME: Or default to v0 or v1? Anything in 'internal' should be able to default to v1, as long as the "old"
		// entrypoints apply v0 (which they do).
...
func (c *BundleCompiler) init() error {
...
func (c *BundleCompiler) checkNumEntrypoints() error {
...
func (c *BundleCompiler) dedupEntrypointRefs() error {
...
func (c *BundleCompiler) Bundle() *bundle.Bundle {
	return c.bundle
}

func (c *BundleCompiler) initBundle(usePath bool) error {
...
func (c *BundleCompiler) optimize(ctx context.Context) error {
	if c.optimizationLevel <= 0 {
		var err error
		c.compiler, err = compile(c.capabilities, c.regoVersion, c.bundle, c.debug, c.enablePrintStatements)
		return err
	}
...
func (c *BundleCompiler) compilePlan(context.Context) error {
...
func (c *BundleCompiler) compileWasm(ctx context.Context) error {
...
func (c *BundleCompiler) isPackage(term *ast.Term) bool {
...
func (o *optimizer) Do(ctx context.Context) error {
	...
	for i, e := range o.entrypoints {
		...
		var err error
		o.compiler, err = compile(o.capabilities, o.regoVersion, o.bundle, o.debug, o.enablePrintStatements)
		if err != nil {
			return err
		}
...
func compile(c *ast.Capabilities, defaultRegoVersion ast.RegoVersion, b *bundle.Bundle, dbg debug.Debug, enablePrintStatements bool) (*ast.Compiler, error) {
