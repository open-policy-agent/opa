...
>
  ...
  >
    ...
    <img
      src={require('./assets/index/styra.png').default}
      alt="Styra Logo"
      style={{ width: '6rem' }}
    />
  </p>
...
<SideBySideContainer>
  <SideBySideColumn>
    ...
    <img src={require('./assets/index/deployment/daemon.png').default}
  ...
  <SideBySideColumn>
    ...
    <img src={require('./assets/index/deployment/library.png').default}
      alt="Deployment Options"
      style={{ display: 'block', margin: "0 auto", maxWidth: '15rem', height: 'auto' }} />
  </SideBySideColumn>
</SideBySideContainer>
...
<ImageCard
  item={{
    image: require('./assets/index/uis/playground.png').default,
...
<ImageCard
  item={{
    image: require('./assets/index/uis/vscode.png').default,
...
<ImageCard
  item={{
    image: require('./assets/index/uis/cli.png').default,
