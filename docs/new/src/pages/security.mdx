...
- If you have not received a reply to your report within two days, please reach out on our [Slack](https://inviter.co/opa/) by posting a message in the `#contributors` channel.
...
- [Slack](https://inviter.co/opa/) `#announcements` channel
