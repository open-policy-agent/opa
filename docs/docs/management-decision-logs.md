...
| `[_].evaluated_rules`              | `array[string]` | List of annotation `id` values for rules that were successfully evaluated. Present automatically when any loaded policy contains rules with `id` annotations, or when external rule sources are registered.                                                                                                                                                                                             |
