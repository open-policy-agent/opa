...
| `[_].decision_label`      | `object` | Key-value pairs of non-deterministic content, containing information about the success or failure of an authorization ruling which will be maintained in the output of the Decision Log and allow for more direct record keeping.                                                                                                                                                                       |
