...
| `status.buffer_status_limit` | `string`       | No (default: `10`)                                                                                                                                                                                                                                      | Controls the limit of status updates that can be buffered, if the buffer is full drop the oldest status update will be dropped. This prevents blocking due to a slow status API.                                                                                   |
