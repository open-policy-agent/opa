...
| `decision_logs.drop_decision` | `string` | No (default: `/system/log/drop`) | Set path of drop decision. If this rule evaluates to `true`, the decision will not be logged. |
