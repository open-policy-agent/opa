...
//
// Deprecated: use [github.com/open-policy-agent/opa/v1/compile.BundleCompiler] instead.
type Compiler = v1.BundleCompiler

// New returns a new compiler instance that can be invoked.
//
// By default, thr returned compiler creates bundles with rego-version set to [ast.RegoV0].
// To default to [ast.RegoV1], use [github.com/open-policy-agent/opa/v1/compile.NewBundleCompiler],
// or explicitly set the rego-version on the compiler returned here using [Compiler.WithRegoVersion].
//
// Equivalent to
//
//	NewBundleCompiler().WithRegoVersion(ast.RegoV0)
//
// in the [github.com/open-policy-agent/opa/v1/compile] package.
//
// Deprecated: use [github.com/open-policy-agent/opa/v1/compile.NewBundleCompiler] instead.
func New() *Compiler {
	return v1.NewBundleCompiler().WithRegoVersion(ast.RegoV0)
}
