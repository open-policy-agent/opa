...
seccomp_unconfined :-
    ...
    request.Body.HostConfig.SecurityOpt[_] = "seccomp:unconfined"
...
```shell
$ curl -v -G http://localhost:8181/v1/data/opa/example/allow_request --data-urlencode 'request=:{"Body":{"HostConfig":{"SecurityOpt":["seccomp:unconfined"]}}}'
```
...
```shell
$ curl -G http://localhost:8181/v1/data/opa/example/allow_request --data-urlencode 'request=:{"Body":{"HostConfig":{"SecurityOpt":["seccomp:default"]}}}'
```
