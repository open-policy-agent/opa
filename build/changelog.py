...
def get_changelog_message(commit_message, issue_id, mention, reporter, repo_url):
    if issue_id:
        ...
        return "Fixes", "{subject} ([#{issue_id}]({repo_url}/issues/{issue_id})) {mention}{reporter} ".format(subject=subject, issue_id=issue_id, repo_url=repo_url, reporter=reporter, mention=mention)
