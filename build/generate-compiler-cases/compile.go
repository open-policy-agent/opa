...
// compileCase compiles a case's modules and returns the diagnostics, sorted.
...
func compileCase(tc compilecases.TestCase) ([]conformance.Error, error) {
	...
	slices.SortFunc(got, func(a, b conformance.Error) int {
		return cmp.Or(
