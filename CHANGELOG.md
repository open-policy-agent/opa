...
This release includes a new built-in function to generate an array of numbers in a range: `numbers.range` ([#2479](https://github.com/open-policy-agent/opa/issues/2479)).
...
- The project's CI/CD infrastructure has been migrated to GitHub Actions (previously it relied on Travis CI). The new CI/CD infrastructure is designed and implemented to be portable and includes a number of quality-of-life improvements.
