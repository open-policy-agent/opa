const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DHE3is6j.js","assets/index-BJ-EWXsP.js","assets/index-OtU1FwPq.js","assets/index-BpnxgGp1.js","assets/index-BPsfCzjV.js","assets/index-DZT3fNbf.js","assets/index-CVl2arsV.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-OtU1FwPq.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHE3is6j.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BpnxgGp1.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BPsfCzjV.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZT3fNbf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CVl2arsV.js");
        return { parser };
