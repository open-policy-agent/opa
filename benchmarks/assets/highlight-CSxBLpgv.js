const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C7Z_L8KH.js","assets/index-4XAOBb4v.js","assets/index-C9Ks0V_R.js","assets/index-DCl0p83s.js","assets/index-CJqjVfzK.js","assets/index-CxglFsse.js","assets/index-D2nC-us7.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C9Ks0V_R.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C7Z_L8KH.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCl0p83s.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CJqjVfzK.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CxglFsse.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D2nC-us7.js");
        return { parser };
