const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-s72Er8P7.js","assets/index-CeoeGCET.js","assets/index-BJbWg6Sh.js","assets/index-CioqFTkx.js","assets/index-CNwhrWLn.js","assets/index-CRLoRkPg.js","assets/index-Byk2socr.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BJbWg6Sh.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-s72Er8P7.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CioqFTkx.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNwhrWLn.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CRLoRkPg.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Byk2socr.js");
        return { parser };
