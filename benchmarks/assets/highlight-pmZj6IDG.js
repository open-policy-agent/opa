const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B8p2Q6He.js","assets/index-C0-y4_kX.js","assets/index-B0vawAN9.js","assets/index-gNaxa0B9.js","assets/index-BojMEixJ.js","assets/index-CrjQ2ylz.js","assets/index-BBK_74oM.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B0vawAN9.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B8p2Q6He.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-gNaxa0B9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BojMEixJ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CrjQ2ylz.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BBK_74oM.js");
        return { parser };
