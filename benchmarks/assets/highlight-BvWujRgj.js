const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bt8O7NRN.js","assets/index-ClZ8VUwG.js","assets/index-CfmgM6Gx.js","assets/index-B4wjiWVa.js","assets/index-BQd92CwS.js","assets/index-DDvjVwAd.js","assets/index-BeQl4ImR.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CfmgM6Gx.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bt8O7NRN.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B4wjiWVa.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BQd92CwS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DDvjVwAd.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BeQl4ImR.js");
        return { parser };
