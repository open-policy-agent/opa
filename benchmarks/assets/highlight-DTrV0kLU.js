const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DWmH0RpO.js","assets/index-CnEWfb9n.js","assets/index-BojIolAv.js","assets/index-D8cBMUUM.js","assets/index-B2L3EXqW.js","assets/index-tlevdxLi.js","assets/index-BHjVDo11.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BojIolAv.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DWmH0RpO.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D8cBMUUM.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B2L3EXqW.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-tlevdxLi.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BHjVDo11.js");
        return { parser };
