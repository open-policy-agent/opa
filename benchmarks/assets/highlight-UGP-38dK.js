const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CI6Ta4sZ.js","assets/index-Cnd9yJmj.js","assets/index-CwPbSmL0.js","assets/index-CDtumtHy.js","assets/index-CnR7o99S.js","assets/index-BhL1dHWr.js","assets/index-CCKT6HLX.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CwPbSmL0.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CI6Ta4sZ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CDtumtHy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CnR7o99S.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BhL1dHWr.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CCKT6HLX.js");
        return { parser };
