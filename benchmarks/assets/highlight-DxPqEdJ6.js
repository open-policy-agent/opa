const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D5DLwnSs.js","assets/index-CokLfHRC.js","assets/index-Bm0VnPtE.js","assets/index-hBaKs_cm.js","assets/index-BI3Lck_M.js","assets/index-Cp03RDa4.js","assets/index-Cnyr0iVW.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bm0VnPtE.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D5DLwnSs.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-hBaKs_cm.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BI3Lck_M.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cp03RDa4.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cnyr0iVW.js");
        return { parser };
