const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D4zPIbZl.js","assets/index-8E3Pw3xd.js","assets/index-BwUwa3iE.js","assets/index-UoujBC3H.js","assets/index-BdOJtIb9.js","assets/index-5PLQSIKD.js","assets/index-MEjL_Oq7.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BwUwa3iE.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D4zPIbZl.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-UoujBC3H.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BdOJtIb9.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5PLQSIKD.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-MEjL_Oq7.js");
        return { parser };
