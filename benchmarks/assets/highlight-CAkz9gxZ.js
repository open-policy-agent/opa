const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B5xJXQJe.js","assets/index-Cbl33eLB.js","assets/index-BJW7HwGe.js","assets/index-BtMuzKIR.js","assets/index-C47Cqmop.js","assets/index-CUSPVGrb.js","assets/index-DTUGRaV8.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BJW7HwGe.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B5xJXQJe.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BtMuzKIR.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C47Cqmop.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CUSPVGrb.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DTUGRaV8.js");
        return { parser };
