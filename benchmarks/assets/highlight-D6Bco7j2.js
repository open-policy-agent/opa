const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Ba9jrwVY.js","assets/index-D7_mABdD.js","assets/index-1d8rcAkJ.js","assets/index-PGPbcTUC.js","assets/index-SClCD6MD.js","assets/index-CiytpRt0.js","assets/index-DdBMVWJA.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-1d8rcAkJ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ba9jrwVY.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-PGPbcTUC.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SClCD6MD.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CiytpRt0.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DdBMVWJA.js");
        return { parser };
