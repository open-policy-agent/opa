const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-KH1evyGH.js","assets/index-Dk70OxLY.js","assets/index-CMw-rmqN.js","assets/index-DeyLtf5E.js","assets/index-D4RayMnU.js","assets/index-NTpGuRsS.js","assets/index-k6mnziZB.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CMw-rmqN.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-KH1evyGH.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DeyLtf5E.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D4RayMnU.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-NTpGuRsS.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-k6mnziZB.js");
        return { parser };
