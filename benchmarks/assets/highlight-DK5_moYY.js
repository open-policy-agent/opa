const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D74kuBBR.js","assets/index-5X4enqmV.js","assets/index-hftlqkfk.js","assets/index-Dp0XJomX.js","assets/index-DXAZdurX.js","assets/index-B302iqJ0.js","assets/index-3LR0_JQJ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-hftlqkfk.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D74kuBBR.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dp0XJomX.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DXAZdurX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B302iqJ0.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3LR0_JQJ.js");
        return { parser };
