const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DFlxm_BT.js","assets/index-DHnjizTH.js","assets/index-BQEJr_L0.js","assets/index-9N8kcOt4.js","assets/index-ubKNyN1G.js","assets/index-B8cyght2.js","assets/index-BxbYy3pk.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BQEJr_L0.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DFlxm_BT.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-9N8kcOt4.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ubKNyN1G.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B8cyght2.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BxbYy3pk.js");
        return { parser };
