const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BL1UrGBl.js","assets/index-BE42SXQz.js","assets/index-CiY4K2kJ.js","assets/index-CRObS4jY.js","assets/index-BqfwFNa_.js","assets/index-D6M-ixE-.js","assets/index-CduRaBm0.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CiY4K2kJ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BL1UrGBl.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CRObS4jY.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqfwFNa_.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D6M-ixE-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CduRaBm0.js");
        return { parser };
