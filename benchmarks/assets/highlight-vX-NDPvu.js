const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CeosHMDY.js","assets/index-BhLduECn.js","assets/index-vDfmP_rG.js","assets/index-C2kT7Lo1.js","assets/index-BHFZwK3a.js","assets/index-Dv9KY74X.js","assets/index-BiA3tPHm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-vDfmP_rG.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CeosHMDY.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C2kT7Lo1.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BHFZwK3a.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dv9KY74X.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BiA3tPHm.js");
        return { parser };
