const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-gnyr7gh4.js","assets/index-BXa94cDN.js","assets/index-DJ_4r3bU.js","assets/index-BWBfx0rj.js","assets/index-XoYRMTuB.js","assets/index-cbMvG5gl.js","assets/index-5UdqEXcS.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DJ_4r3bU.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-gnyr7gh4.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BWBfx0rj.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XoYRMTuB.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-cbMvG5gl.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5UdqEXcS.js");
        return { parser };
