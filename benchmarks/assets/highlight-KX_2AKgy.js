const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CJHUApsi.js","assets/index-zuE9mQH-.js","assets/index-DkcYCGi_.js","assets/index-Bv_PPTT7.js","assets/index-C5WYnZY0.js","assets/index-CZ9Sjl06.js","assets/index--A_lBxH2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DkcYCGi_.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CJHUApsi.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bv_PPTT7.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5WYnZY0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZ9Sjl06.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index--A_lBxH2.js");
        return { parser };
