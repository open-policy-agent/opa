const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-kVwA4fUp.js","assets/index-CNk02X-3.js","assets/index-IGlKOMx4.js","assets/index-DCBCQwpf.js","assets/index-DufSD8CX.js","assets/index-B97hldZR.js","assets/index-DKo4Qgmm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-IGlKOMx4.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-kVwA4fUp.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCBCQwpf.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DufSD8CX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B97hldZR.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DKo4Qgmm.js");
        return { parser };
