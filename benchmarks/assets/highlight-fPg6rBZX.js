const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-V7CdC04h.js","assets/index-DDz0DdKl.js","assets/index-CR4hQUkN.js","assets/index-BotszjM4.js","assets/index-BcOSFrMg.js","assets/index-Dg97FSy7.js","assets/index-C5stLJ6E.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CR4hQUkN.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-V7CdC04h.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BotszjM4.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BcOSFrMg.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dg97FSy7.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5stLJ6E.js");
        return { parser };
