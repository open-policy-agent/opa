const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-x_jppC4_.js","assets/index-DVVNun1U.js","assets/index-dI8NtNr_.js","assets/index-h6lbZUT2.js","assets/index-CxOoeM-m.js","assets/index-DSdYzTYX.js","assets/index-TkOb_aiX.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-dI8NtNr_.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-x_jppC4_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-h6lbZUT2.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CxOoeM-m.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSdYzTYX.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-TkOb_aiX.js");
        return { parser };
