const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BTyReykp.js","assets/index-CjJXTG28.js","assets/index-BVLTOl4c.js","assets/index-CoH1UDrk.js","assets/index-CLD2aCWq.js","assets/index-BXY7mjlj.js","assets/index-D9b_yWNv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BVLTOl4c.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BTyReykp.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CoH1UDrk.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CLD2aCWq.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BXY7mjlj.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9b_yWNv.js");
        return { parser };
