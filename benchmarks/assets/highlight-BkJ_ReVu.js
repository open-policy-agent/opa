const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Cr-q3Wai.js","assets/index-CQaj6-aJ.js","assets/index-CbrmRHoL.js","assets/index-DHjwoEAM.js","assets/index-ooBnk_HS.js","assets/index-DQ4WgoOQ.js","assets/index-yTy5Wkj3.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CbrmRHoL.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cr-q3Wai.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHjwoEAM.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ooBnk_HS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DQ4WgoOQ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yTy5Wkj3.js");
        return { parser };
