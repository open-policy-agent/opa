const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BYOHvNN_.js","assets/index-w5pJRdtQ.js","assets/index-BXatVPOI.js","assets/index-C-sbvRNe.js","assets/index-D7tNQuSP.js","assets/index-QMAZYz78.js","assets/index-BenLIYqZ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BXatVPOI.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BYOHvNN_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C-sbvRNe.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D7tNQuSP.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-QMAZYz78.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BenLIYqZ.js");
        return { parser };
