const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-6H-ValHc.js","assets/index-D_4Ku0Kx.js","assets/index-BDzj7SMU.js","assets/index-BH__ScFh.js","assets/index-yheZVASu.js","assets/index-A3Cd7zgT.js","assets/index-C2ZwrwAi.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BDzj7SMU.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-6H-ValHc.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BH__ScFh.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yheZVASu.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-A3Cd7zgT.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C2ZwrwAi.js");
        return { parser };
