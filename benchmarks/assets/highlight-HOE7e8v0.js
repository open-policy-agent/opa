const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CSVGLyVm.js","assets/index-CiRaX7x4.js","assets/index-DIrZbeSS.js","assets/index-G_ORhEhg.js","assets/index-81NQqg_H.js","assets/index-Dp1j8IHN.js","assets/index-CEbLcgLH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DIrZbeSS.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSVGLyVm.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-G_ORhEhg.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-81NQqg_H.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dp1j8IHN.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CEbLcgLH.js");
        return { parser };
