const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CozHoVxs.js","assets/index-hz6Ni0-z.js","assets/index-CPkNSqWT.js","assets/index-Csc5cSeV.js","assets/index-CeurLMDq.js","assets/index-DV7eyKYL.js","assets/index-CSX3qNdp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CPkNSqWT.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CozHoVxs.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Csc5cSeV.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CeurLMDq.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DV7eyKYL.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSX3qNdp.js");
        return { parser };
