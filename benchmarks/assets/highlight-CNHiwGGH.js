const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dgoe7PLy.js","assets/index-Cb2MbZ1V.js","assets/index-B0sDO9jT.js","assets/index-DRm4vCAi.js","assets/index-CoVH0caj.js","assets/index-D_5EZq9i.js","assets/index-DRQbklpu.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B0sDO9jT.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dgoe7PLy.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DRm4vCAi.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CoVH0caj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D_5EZq9i.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DRQbklpu.js");
        return { parser };
