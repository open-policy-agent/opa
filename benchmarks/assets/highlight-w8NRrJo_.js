const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BlR78Esd.js","assets/index-BmrTIf8C.js","assets/index-BLfYhxR8.js","assets/index-pvQfxVXo.js","assets/index-D4I0ILQJ.js","assets/index-DMdmd_hW.js","assets/index-BcCzus7v.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BLfYhxR8.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BlR78Esd.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-pvQfxVXo.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D4I0ILQJ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DMdmd_hW.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BcCzus7v.js");
        return { parser };
