const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CpL3nibm.js","assets/index-DJnMmlQ2.js","assets/index-BH8nGf3G.js","assets/index-Dwf6LkdP.js","assets/index-D_qy7lHx.js","assets/index-6FapWMIs.js","assets/index-T1EAK2eJ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BH8nGf3G.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CpL3nibm.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dwf6LkdP.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D_qy7lHx.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-6FapWMIs.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-T1EAK2eJ.js");
        return { parser };
