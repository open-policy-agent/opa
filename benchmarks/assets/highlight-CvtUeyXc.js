const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-lHrfgboz.js","assets/index-CIzNRYkJ.js","assets/index-BuXuQEdN.js","assets/index-C-4N1Nz5.js","assets/index-CeXIYS7O.js","assets/index-46jJJwKm.js","assets/index-DV_ewoY2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BuXuQEdN.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-lHrfgboz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C-4N1Nz5.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CeXIYS7O.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-46jJJwKm.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DV_ewoY2.js");
        return { parser };
