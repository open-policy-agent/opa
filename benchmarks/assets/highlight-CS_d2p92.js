const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-mkU-U9HZ.js","assets/index-TioL5nPe.js","assets/index-mtP-3k2e.js","assets/index-CNj1L_dJ.js","assets/index-DwgvW-qU.js","assets/index-BmEzvXYY.js","assets/index-BQRWXOfd.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-mtP-3k2e.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mkU-U9HZ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNj1L_dJ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DwgvW-qU.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BmEzvXYY.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BQRWXOfd.js");
        return { parser };
