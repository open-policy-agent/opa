const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CRubtJ4O.js","assets/index-Cgl9vQVS.js","assets/index-BLO0I_3f.js","assets/index-LqgMRBDB.js","assets/index-Zlh6jwPj.js","assets/index-BGNCvSDe.js","assets/index-CUC2bffi.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BLO0I_3f.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CRubtJ4O.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-LqgMRBDB.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Zlh6jwPj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BGNCvSDe.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CUC2bffi.js");
        return { parser };
