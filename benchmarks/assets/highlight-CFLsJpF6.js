const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index--kVnhdG3.js","assets/index-3usqdO9y.js","assets/index-D3MjURXF.js","assets/index-B01Zcqx7.js","assets/index-DSHYkngy.js","assets/index-C1EnDCvM.js","assets/index-BqcBJGSW.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-D3MjURXF.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index--kVnhdG3.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B01Zcqx7.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSHYkngy.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C1EnDCvM.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqcBJGSW.js");
        return { parser };
