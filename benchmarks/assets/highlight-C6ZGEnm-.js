const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DU9HJZlG.js","assets/index-ZFPfDqhV.js","assets/index-CJinuZLz.js","assets/index-PFyWmmCy.js","assets/index-c3Wabff2.js","assets/index-CzTEyciS.js","assets/index-DvnbUP3n.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CJinuZLz.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DU9HJZlG.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-PFyWmmCy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-c3Wabff2.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CzTEyciS.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DvnbUP3n.js");
        return { parser };
