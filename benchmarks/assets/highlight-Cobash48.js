const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BWJOALTP.js","assets/index-BG7BLe52.js","assets/index-B-SuoAGS.js","assets/index-T8xUSV90.js","assets/index-C-K99Oho.js","assets/index-DHkI7bJH.js","assets/index-CAO7NsZU.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B-SuoAGS.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BWJOALTP.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-T8xUSV90.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C-K99Oho.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHkI7bJH.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAO7NsZU.js");
        return { parser };
