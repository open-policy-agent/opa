const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BBqeEMzo.js","assets/index-DsKEBLTy.js","assets/index-vLnZE9pq.js","assets/index-5CB4juCE.js","assets/index-C1TL26KI.js","assets/index-BhI_ASCd.js","assets/index-DZ6KtGRf.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-vLnZE9pq.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BBqeEMzo.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5CB4juCE.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C1TL26KI.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BhI_ASCd.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZ6KtGRf.js");
        return { parser };
