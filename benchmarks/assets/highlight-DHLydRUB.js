const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DKiTbFp8.js","assets/index-B8d2rDNm.js","assets/index-DQY31U1e.js","assets/index-CiDHdbCZ.js","assets/index-C-Vcm7iW.js","assets/index-DbVDB_Am.js","assets/index-DQzuAIPs.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DQY31U1e.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DKiTbFp8.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CiDHdbCZ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C-Vcm7iW.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DbVDB_Am.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DQzuAIPs.js");
        return { parser };
