const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BQOrhiiq.js","assets/index-CYF0SRg8.js","assets/index-BpkUA-vR.js","assets/index-xLqOja9e.js","assets/index-Uia9_ssD.js","assets/index-DKMEuvSi.js","assets/index-C5ROTHq2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BpkUA-vR.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BQOrhiiq.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-xLqOja9e.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Uia9_ssD.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DKMEuvSi.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5ROTHq2.js");
        return { parser };
