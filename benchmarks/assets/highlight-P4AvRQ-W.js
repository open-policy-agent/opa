const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D1auXxH3.js","assets/index-NQnuXztW.js","assets/index-Da-bXzN7.js","assets/index-B3VZPuPK.js","assets/index-C4nP_UUG.js","assets/index-zoxrfORF.js","assets/index-Co_-OXIS.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Da-bXzN7.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D1auXxH3.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3VZPuPK.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C4nP_UUG.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-zoxrfORF.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Co_-OXIS.js");
        return { parser };
