const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-sRG3KoYa.js","assets/index-BhLQMujM.js","assets/index-C3BC7Ue5.js","assets/index-_ovzlHvk.js","assets/index-PLpWlv5b.js","assets/index-CJJw15SO.js","assets/index-trS32LLO.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C3BC7Ue5.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-sRG3KoYa.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-_ovzlHvk.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-PLpWlv5b.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CJJw15SO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-trS32LLO.js");
        return { parser };
