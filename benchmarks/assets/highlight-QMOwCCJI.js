const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DEocpx9n.js","assets/index-CUnfFwbo.js","assets/index-zdTRjd2I.js","assets/index-DHmXh2yi.js","assets/index-2T6F1Yz8.js","assets/index-8RQbMZGb.js","assets/index-D0clznrp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-zdTRjd2I.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DEocpx9n.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHmXh2yi.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-2T6F1Yz8.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-8RQbMZGb.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D0clznrp.js");
        return { parser };
