...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-Dj0iuMdf.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-DsvTJqwc.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-DClwy64q.json", import.meta.url).href).json();
    },
