const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-2NzfmOfn.js","assets/index-DqXQxhcW.js","assets/index-CTfv5dJB.js","assets/index-B7yxn968.js","assets/index-CMtvvTu5.js","assets/index-DB5nb6MR.js","assets/index-DXoquFz-.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CTfv5dJB.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-2NzfmOfn.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B7yxn968.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CMtvvTu5.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DB5nb6MR.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DXoquFz-.js");
        return { parser };
