const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DaxzRyWz.js","assets/index-DJRAgeyX.js","assets/index-CsL1Mtxs.js","assets/index-CjLWRJcT.js","assets/index-B_CPbuEB.js","assets/index-I2yA9wHl.js","assets/index-ANYJC1fG.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CsL1Mtxs.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DaxzRyWz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CjLWRJcT.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B_CPbuEB.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-I2yA9wHl.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ANYJC1fG.js");
        return { parser };
