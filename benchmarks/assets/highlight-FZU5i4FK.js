const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-OzMVhAzl.js","assets/index-APHYdUyx.js","assets/index-DqpV0iui.js","assets/index-CPJ7Sl7T.js","assets/index-BNQlwl1I.js","assets/index-Bfh1fwKD.js","assets/index-CMkt-54v.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DqpV0iui.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-OzMVhAzl.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CPJ7Sl7T.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BNQlwl1I.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bfh1fwKD.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CMkt-54v.js");
        return { parser };
