const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DSlmldie.js","assets/index-dckv0JIh.js","assets/index-Bjx2hmw1.js","assets/index-DCt5b_ci.js","assets/index-sb9wWjL1.js","assets/index-CfqPmhHC.js","assets/index-DLBSIbYU.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bjx2hmw1.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSlmldie.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCt5b_ci.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-sb9wWjL1.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CfqPmhHC.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DLBSIbYU.js");
        return { parser };
