const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DNjBYfQ8.js","assets/index-s765xU8E.js","assets/index-BFgjvqkF.js","assets/index-DHyex_Fm.js","assets/index-wD4l5dD7.js","assets/index-qeobqVOL.js","assets/index-CHympp_D.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BFgjvqkF.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DNjBYfQ8.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHyex_Fm.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-wD4l5dD7.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-qeobqVOL.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CHympp_D.js");
        return { parser };
