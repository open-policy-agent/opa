const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CQNXb5eW.js","assets/index-BLRprMvi.js","assets/index-DTlmjomp.js","assets/index-Co4pAwjw.js","assets/index-Dkc0S7_m.js","assets/index-B3orKsli.js","assets/index-GVbKUOQL.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DTlmjomp.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQNXb5eW.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Co4pAwjw.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dkc0S7_m.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3orKsli.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-GVbKUOQL.js");
        return { parser };
