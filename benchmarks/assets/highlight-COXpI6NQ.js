const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BuBFpuFY.js","assets/index-Lt8A6RMf.js","assets/index-CukBJ6tw.js","assets/index-C1lZ1fR5.js","assets/index-AixDL1OP.js","assets/index-inczeJnR.js","assets/index-B9Cny2-O.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CukBJ6tw.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BuBFpuFY.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C1lZ1fR5.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-AixDL1OP.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-inczeJnR.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B9Cny2-O.js");
        return { parser };
