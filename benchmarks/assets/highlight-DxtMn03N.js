const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-p--1Hb-u.js","assets/index-CrFCi7Is.js","assets/index-Dn16m8Qi.js","assets/index-CujUaQPw.js","assets/index-3slNYYaS.js","assets/index-BqQZzpym.js","assets/index-Dteqlblv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Dn16m8Qi.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-p--1Hb-u.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CujUaQPw.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3slNYYaS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqQZzpym.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dteqlblv.js");
        return { parser };
