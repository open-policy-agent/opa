const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C5rNreI5.js","assets/index-vAAi3QFh.js","assets/index-DHwLl3Ea.js","assets/index-Be56k0OT.js","assets/index-JbPmoqnb.js","assets/index-BKS3At2Q.js","assets/index-BJrDVagn.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DHwLl3Ea.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5rNreI5.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Be56k0OT.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-JbPmoqnb.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BKS3At2Q.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BJrDVagn.js");
        return { parser };
