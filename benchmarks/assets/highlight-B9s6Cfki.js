const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CsL9AuVw.js","assets/index-CMGzrX3M.js","assets/index-C-_Maz_r.js","assets/index-B68GL2Sb.js","assets/index-CS5TGuA-.js","assets/index-BtKCeL05.js","assets/index-CYGcq84j.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C-_Maz_r.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CsL9AuVw.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B68GL2Sb.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CS5TGuA-.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BtKCeL05.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CYGcq84j.js");
        return { parser };
