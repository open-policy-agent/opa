const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DnP8FR8l.js","assets/index-8HR2wt2A.js","assets/index-URUaYk85.js","assets/index-CIJbj5XI.js","assets/index-Bhs8vM9B.js","assets/index-CzriC2QO.js","assets/index-vJQb5Dbr.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-URUaYk85.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DnP8FR8l.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CIJbj5XI.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bhs8vM9B.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CzriC2QO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-vJQb5Dbr.js");
        return { parser };
