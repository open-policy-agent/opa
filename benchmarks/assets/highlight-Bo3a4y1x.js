const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-R_JdRzsJ.js","assets/index-cixYzgjA.js","assets/index-CQx4OXf1.js","assets/index-u55WrGUh.js","assets/index-C0g9xi0f.js","assets/index-D24qIwGf.js","assets/index-BV_esWoI.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CQx4OXf1.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-R_JdRzsJ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-u55WrGUh.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C0g9xi0f.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D24qIwGf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BV_esWoI.js");
        return { parser };
