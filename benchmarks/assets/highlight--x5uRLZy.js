const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-y7MBXNoZ.js","assets/index-BNID9Kaf.js","assets/index-2vxu_GqS.js","assets/index-B80QmKAP.js","assets/index-CFF1xwG2.js","assets/index-DGh1BiMl.js","assets/index-DxG56NB_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-2vxu_GqS.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-y7MBXNoZ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B80QmKAP.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CFF1xwG2.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DGh1BiMl.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DxG56NB_.js");
        return { parser };
