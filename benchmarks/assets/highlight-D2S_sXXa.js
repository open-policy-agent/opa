const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ua-Os1PP.js","assets/index-BU2lQL_7.js","assets/index-Cztu11LI.js","assets/index-CKoEfFYv.js","assets/index-BAlC2tfz.js","assets/index-Daww2Wi_.js","assets/index-CDmCNEiH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Cztu11LI.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ua-Os1PP.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CKoEfFYv.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BAlC2tfz.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Daww2Wi_.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CDmCNEiH.js");
        return { parser };
