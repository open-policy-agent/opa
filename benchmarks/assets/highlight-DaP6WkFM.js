const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DrYx_22m.js","assets/index-_jc3sxPe.js","assets/index-Bc2O5KC8.js","assets/index-BJlSZRfH.js","assets/index-C_oQQPHI.js","assets/index-Ch9konYF.js","assets/index-DESW5qBv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bc2O5KC8.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DrYx_22m.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BJlSZRfH.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C_oQQPHI.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ch9konYF.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DESW5qBv.js");
        return { parser };
