const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DXjezF0t.js","assets/index-DJogSus8.js","assets/index-DNQxaVFK.js","assets/index-4ueHcLeD.js","assets/index-TUEa5A7r.js","assets/index-BTKwwqm8.js","assets/index-DkDa64ok.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DNQxaVFK.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DXjezF0t.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-4ueHcLeD.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-TUEa5A7r.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BTKwwqm8.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DkDa64ok.js");
        return { parser };
