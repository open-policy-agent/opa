const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BMwixnnu.js","assets/index-DhMOcnMQ.js","assets/index-Bfe4ncet.js","assets/index-BjS7qvYZ.js","assets/index-Cn2WIrNj.js","assets/index-DADQ3Cuf.js","assets/index-Df-rNcAC.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bfe4ncet.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BMwixnnu.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BjS7qvYZ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cn2WIrNj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DADQ3Cuf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Df-rNcAC.js");
        return { parser };
