const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CODTfSO0.js","assets/index-Bl7-nsvK.js","assets/index-CooRw31F.js","assets/index-D-kK7dRb.js","assets/index-BSJsYEWB.js","assets/index-CehtQRgG.js","assets/index-D3LrRxMy.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CooRw31F.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CODTfSO0.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-kK7dRb.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BSJsYEWB.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CehtQRgG.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D3LrRxMy.js");
        return { parser };
