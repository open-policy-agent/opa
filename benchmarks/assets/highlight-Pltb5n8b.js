const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bxv2JJBQ.js","assets/index-rvwiUPDg.js","assets/index-CcMAK-Dw.js","assets/index-CLC2rnTK.js","assets/index-ClBalZHX.js","assets/index-BsToubG2.js","assets/index-DoTODjFg.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CcMAK-Dw.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bxv2JJBQ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CLC2rnTK.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ClBalZHX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BsToubG2.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DoTODjFg.js");
        return { parser };
