const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D5A4Gv-9.js","assets/index-C_c6pG0o.js","assets/index-CPGowTPo.js","assets/index-Bq4Oe5ng.js","assets/index-CGhB7Mcd.js","assets/index-DFgQIOyz.js","assets/index-BZCr-Ffm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CPGowTPo.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D5A4Gv-9.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bq4Oe5ng.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGhB7Mcd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DFgQIOyz.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BZCr-Ffm.js");
        return { parser };
