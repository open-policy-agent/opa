const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B8bHwgwA.js","assets/index-BdVsN_RZ.js","assets/index-CnF6UYwP.js","assets/index-T3mpo2H_.js","assets/index-b5N4Anep.js","assets/index-Pq5g3vmG.js","assets/index-BYi-XhHo.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CnF6UYwP.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B8bHwgwA.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-T3mpo2H_.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-b5N4Anep.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Pq5g3vmG.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BYi-XhHo.js");
        return { parser };
