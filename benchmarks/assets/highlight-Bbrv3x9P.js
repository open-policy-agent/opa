const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-KSNZixBv.js","assets/index-BQETCGW0.js","assets/index-9P6lZhbQ.js","assets/index-CqPJjJ5N.js","assets/index-oXfj3_mE.js","assets/index-C23j4lQf.js","assets/index-DhdPyftl.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-9P6lZhbQ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-KSNZixBv.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CqPJjJ5N.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-oXfj3_mE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C23j4lQf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DhdPyftl.js");
        return { parser };
