const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DNBDoZ-K.js","assets/index-DHod03Jb.js","assets/index-CnpEehLI.js","assets/index-BGJjFEUH.js","assets/index-B-bOSi7M.js","assets/index-Cj4Tbk_k.js","assets/index-DMSKF1o0.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CnpEehLI.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DNBDoZ-K.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BGJjFEUH.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B-bOSi7M.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cj4Tbk_k.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DMSKF1o0.js");
        return { parser };
