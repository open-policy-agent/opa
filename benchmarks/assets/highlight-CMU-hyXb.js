const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ciAiNJ13.js","assets/index-CRrpQQMV.js","assets/index-Bt2w3x9C.js","assets/index-3EFRdOed.js","assets/index-DD4C1Fbv.js","assets/index-BRtMdJ5C.js","assets/index-9xr_mftt.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bt2w3x9C.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ciAiNJ13.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3EFRdOed.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DD4C1Fbv.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BRtMdJ5C.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-9xr_mftt.js");
        return { parser };
