const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BkhyS_Bi.js","assets/index-Upvv85P6.js","assets/index-DWFH1TA5.js","assets/index-DBEaOjIc.js","assets/index-BEoKaDNI.js","assets/index-CqcULaPL.js","assets/index-b7BWyoi6.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DWFH1TA5.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BkhyS_Bi.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DBEaOjIc.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BEoKaDNI.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CqcULaPL.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-b7BWyoi6.js");
        return { parser };
