const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D6VeRiyY.js","assets/index-BrKiZ2nZ.js","assets/index-BocV3LZ2.js","assets/index-Q-o3RrQ6.js","assets/index-BJzqbta-.js","assets/index-Dg3RMSvM.js","assets/index-l7v4wTUy.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BocV3LZ2.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D6VeRiyY.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Q-o3RrQ6.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BJzqbta-.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dg3RMSvM.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-l7v4wTUy.js");
        return { parser };
