const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C_mpssTm.js","assets/index-CQ5p5pFy.js","assets/index-t7e41tQ2.js","assets/index-D7gUkd2p.js","assets/index-DgZPCBsr.js","assets/index-Bz6br9yi.js","assets/index-DoN4OWhu.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-t7e41tQ2.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C_mpssTm.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D7gUkd2p.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DgZPCBsr.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bz6br9yi.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DoN4OWhu.js");
        return { parser };
