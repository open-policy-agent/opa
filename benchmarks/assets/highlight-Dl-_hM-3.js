const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-33B1NX9d.js","assets/index-B42Vdkzx.js","assets/index-Djno6Bel.js","assets/index-CGIrqVWO.js","assets/index-D-xk1NWt.js","assets/index-D6uQByOy.js","assets/index-CYgylZPR.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Djno6Bel.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-33B1NX9d.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGIrqVWO.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-xk1NWt.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D6uQByOy.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CYgylZPR.js");
        return { parser };
