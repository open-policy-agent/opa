const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DCGntzUt.js","assets/index-D5WbG9ex.js","assets/index-5-1aeVVm.js","assets/index-DnlZZfhN.js","assets/index-BBGxkyZt.js","assets/index-wSbs4tnI.js","assets/index-DJcRUe9h.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-5-1aeVVm.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCGntzUt.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DnlZZfhN.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BBGxkyZt.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-wSbs4tnI.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DJcRUe9h.js");
        return { parser };
