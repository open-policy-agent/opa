const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CSxRniVu.js","assets/index-BqJMXHoK.js","assets/index-BKBt-u8e.js","assets/index-DWD6XVrG.js","assets/index-B5i5rWol.js","assets/index-CDk_LRMQ.js","assets/index-DiOAQ5Tv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BKBt-u8e.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSxRniVu.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DWD6XVrG.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B5i5rWol.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CDk_LRMQ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DiOAQ5Tv.js");
        return { parser };
