const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-sqj_1oDL.js","assets/index-C6v5Ns_P.js","assets/index-DOKn0BaF.js","assets/index-DXGhTbWD.js","assets/index-CzYXhV4G.js","assets/index-DQCwLNTm.js","assets/index-DDelLtGQ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DOKn0BaF.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-sqj_1oDL.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DXGhTbWD.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CzYXhV4G.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DQCwLNTm.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DDelLtGQ.js");
        return { parser };
