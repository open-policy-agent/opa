const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BLF5FJ87.js","assets/index-BkO2W-sW.js","assets/index-Cmngs1Tz.js","assets/index-DRJR4gob.js","assets/index-DzJhFRJT.js","assets/index-bNhzvWmu.js","assets/index-S1wKP6U_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Cmngs1Tz.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BLF5FJ87.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DRJR4gob.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DzJhFRJT.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-bNhzvWmu.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-S1wKP6U_.js");
        return { parser };
