const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dy1IrDi6.js","assets/index-lusQu0jG.js","assets/index-CRe0FMtq.js","assets/index-BpfB_yLw.js","assets/index-BeFx7gvn.js","assets/index-D5wnA7xT.js","assets/index-Lyb-UX0T.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CRe0FMtq.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dy1IrDi6.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BpfB_yLw.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BeFx7gvn.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D5wnA7xT.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Lyb-UX0T.js");
        return { parser };
