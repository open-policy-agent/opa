const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CCtv2nWG.js","assets/index-ClCIrKmx.js","assets/index-Ct7S-8PD.js","assets/index-DZxCXAK8.js","assets/index-CHY72TPD.js","assets/index-BruJlgni.js","assets/index-hGsxeC9P.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Ct7S-8PD.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CCtv2nWG.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZxCXAK8.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CHY72TPD.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BruJlgni.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-hGsxeC9P.js");
        return { parser };
