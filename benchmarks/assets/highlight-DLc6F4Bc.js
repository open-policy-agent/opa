const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-yM7b-mdR.js","assets/index-mFDFPJoO.js","assets/index-BvNzIr9x.js","assets/index-V-dN6RIX.js","assets/index-B5OCYwj1.js","assets/index-BqUfX-MO.js","assets/index-DA-OHaqW.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BvNzIr9x.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yM7b-mdR.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-V-dN6RIX.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B5OCYwj1.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqUfX-MO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DA-OHaqW.js");
        return { parser };
