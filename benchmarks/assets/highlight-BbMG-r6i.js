const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-IJFoLTSq.js","assets/index-DY_YTci_.js","assets/index-DB1aHhqf.js","assets/index-CMEXjRRy.js","assets/index-Da_R_WDM.js","assets/index-ZIkxtG3_.js","assets/index-p-OPnOpG.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DB1aHhqf.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-IJFoLTSq.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CMEXjRRy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Da_R_WDM.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ZIkxtG3_.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-p-OPnOpG.js");
        return { parser };
