const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DA4lX_33.js","assets/index-BszzDp1E.js","assets/index-C0BqYx9q.js","assets/index-BPf2M5Zx.js","assets/index-D2gbz6NI.js","assets/index-BVTveA77.js","assets/index-BqwbJFVI.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C0BqYx9q.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DA4lX_33.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BPf2M5Zx.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D2gbz6NI.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BVTveA77.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqwbJFVI.js");
        return { parser };
