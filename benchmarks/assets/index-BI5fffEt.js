...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-Z5cVK_j8.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-DRmAE_9S.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-BfRaNx-H.json", import.meta.url).href).json();
    },
