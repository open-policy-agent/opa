const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CCjg88VW.js","assets/index-B-uJVtm_.js","assets/index-BkhNxIRW.js","assets/index-C_gnfdsE.js","assets/index-CfapYSUS.js","assets/index-VX2rM1d1.js","assets/index-Bo0DopZJ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BkhNxIRW.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CCjg88VW.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C_gnfdsE.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CfapYSUS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-VX2rM1d1.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bo0DopZJ.js");
        return { parser };
