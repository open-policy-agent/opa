const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-3QLzT_po.js","assets/index-Dr73H1uJ.js","assets/index-8zoF7M49.js","assets/index-BgHtW5jM.js","assets/index-BSlDAdoX.js","assets/index-Ch4cuCVl.js","assets/index-CyvA3h12.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-8zoF7M49.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3QLzT_po.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BgHtW5jM.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BSlDAdoX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ch4cuCVl.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CyvA3h12.js");
        return { parser };
