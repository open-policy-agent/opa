const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CO3Ckeel.js","assets/index-BQ9KWOHr.js","assets/index-DzUv0K5N.js","assets/index-N3Vhzr6g.js","assets/index-__ksAJqj.js","assets/index-BShCXgLv.js","assets/index-mw1Do1qn.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DzUv0K5N.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CO3Ckeel.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-N3Vhzr6g.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-__ksAJqj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BShCXgLv.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mw1Do1qn.js");
        return { parser };
