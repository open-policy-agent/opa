const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DTnJeLtP.js","assets/index-CA6hw12s.js","assets/index-Caisi3aJ.js","assets/index-CwqFTWas.js","assets/index-DyhbR_gO.js","assets/index-CntpzJYU.js","assets/index-pmn49cJ0.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Caisi3aJ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DTnJeLtP.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CwqFTWas.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DyhbR_gO.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CntpzJYU.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-pmn49cJ0.js");
        return { parser };
