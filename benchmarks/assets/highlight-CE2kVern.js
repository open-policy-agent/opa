const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B418iD3R.js","assets/index-CXKIrzPq.js","assets/index-BQwQuu6-.js","assets/index-CXRvRBSW.js","assets/index-Cl9Sukv1.js","assets/index-xWORQt-a.js","assets/index-BRp2pVd4.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BQwQuu6-.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B418iD3R.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CXRvRBSW.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cl9Sukv1.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-xWORQt-a.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BRp2pVd4.js");
        return { parser };
