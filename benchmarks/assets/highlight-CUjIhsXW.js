const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-hmqDFon0.js","assets/index-2PTA606L.js","assets/index-57k5YBPV.js","assets/index-BcTCc4Fl.js","assets/index-BIXESUM0.js","assets/index-CoMRH8Ud.js","assets/index-_jZFsh97.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-57k5YBPV.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-hmqDFon0.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BcTCc4Fl.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BIXESUM0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CoMRH8Ud.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-_jZFsh97.js");
        return { parser };
