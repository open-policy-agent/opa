const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DSIOBpWV.js","assets/index-Bn_HNN2x.js","assets/index-CfrxpBMM.js","assets/index-C5yeGGwN.js","assets/index-BhzI6eKZ.js","assets/index-B0Ja9xFx.js","assets/index-aKwRfKVA.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CfrxpBMM.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSIOBpWV.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5yeGGwN.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BhzI6eKZ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B0Ja9xFx.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-aKwRfKVA.js");
        return { parser };
