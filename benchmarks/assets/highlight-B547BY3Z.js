const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CRLBvc00.js","assets/index-DwjkfWZG.js","assets/index-B3A5VkHM.js","assets/index-BEh06Rjy.js","assets/index-3x1W7DR8.js","assets/index-DetT-fA-.js","assets/index-BKZR7zlF.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B3A5VkHM.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CRLBvc00.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BEh06Rjy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3x1W7DR8.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DetT-fA-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BKZR7zlF.js");
        return { parser };
