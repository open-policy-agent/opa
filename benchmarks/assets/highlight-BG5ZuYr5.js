const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CcRxViH6.js","assets/index-BivyLdUr.js","assets/index-CwQzkMOg.js","assets/index-B9UYrPca.js","assets/index-e9LdAqAu.js","assets/index-C78W_UpT.js","assets/index-XA_q8Sfv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CwQzkMOg.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CcRxViH6.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B9UYrPca.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-e9LdAqAu.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C78W_UpT.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XA_q8Sfv.js");
        return { parser };
