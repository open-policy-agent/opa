const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B4wqHBiM.js","assets/index-Cl2S_Phz.js","assets/index-CEg-yYnP.js","assets/index-VdLYvXtG.js","assets/index-Ds7YEay6.js","assets/index-KsWim4pA.js","assets/index-CQZOTBxc.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CEg-yYnP.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B4wqHBiM.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-VdLYvXtG.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ds7YEay6.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-KsWim4pA.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQZOTBxc.js");
        return { parser };
