const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BUoVW1pp.js","assets/index-Bj57l1nN.js","assets/index-BHIoiLwJ.js","assets/index-C1VVYpBz.js","assets/index-DFLjoit8.js","assets/index-R_Ld4-sn.js","assets/index-OH23mEcN.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BHIoiLwJ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BUoVW1pp.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C1VVYpBz.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DFLjoit8.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-R_Ld4-sn.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-OH23mEcN.js");
        return { parser };
