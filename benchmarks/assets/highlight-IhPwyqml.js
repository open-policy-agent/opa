const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bd1DOrSr.js","assets/index-VrUAYgNp.js","assets/index-1MGXQqZY.js","assets/index-SFEHvpDU.js","assets/index-BX1OgxXE.js","assets/index-C4L0YNJU.js","assets/index-CmSwbaoF.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-1MGXQqZY.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bd1DOrSr.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SFEHvpDU.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BX1OgxXE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C4L0YNJU.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CmSwbaoF.js");
        return { parser };
