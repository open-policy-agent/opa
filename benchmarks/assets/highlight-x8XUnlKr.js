const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CAzpYJBW.js","assets/index-tv6Sh-3X.js","assets/index-BMQHAZzO.js","assets/index-CZU-4U0T.js","assets/index-ZHRhFvUC.js","assets/index-BoOiYJ1X.js","assets/index-WO6CGN-B.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BMQHAZzO.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAzpYJBW.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZU-4U0T.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ZHRhFvUC.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BoOiYJ1X.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-WO6CGN-B.js");
        return { parser };
