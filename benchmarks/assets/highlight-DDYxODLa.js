const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CHcnqAAZ.js","assets/index-B9t-4R78.js","assets/index-klRpwUmg.js","assets/index-CZ6mBKh1.js","assets/index-Cq7d8v8c.js","assets/index-BgGkciDt.js","assets/index-Dn8c1-DS.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-klRpwUmg.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CHcnqAAZ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZ6mBKh1.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cq7d8v8c.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BgGkciDt.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dn8c1-DS.js");
        return { parser };
