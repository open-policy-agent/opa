const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Vzv6Uu0W.js","assets/index-CQzKxl0s.js","assets/index-C44vra2Y.js","assets/index-XtDw7eVq.js","assets/index-Dhgqo4iH.js","assets/index-CLYB5Hxv.js","assets/index-CghiCYWO.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C44vra2Y.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Vzv6Uu0W.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XtDw7eVq.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dhgqo4iH.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CLYB5Hxv.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CghiCYWO.js");
        return { parser };
