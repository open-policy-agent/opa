const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CAp1qm-i.js","assets/index-B8o3qAsP.js","assets/index-BGz3fayc.js","assets/index-C4b7SC32.js","assets/index-DtIbd9CT.js","assets/index-RfOhIyuL.js","assets/index-SctYnGjt.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BGz3fayc.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAp1qm-i.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C4b7SC32.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DtIbd9CT.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-RfOhIyuL.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SctYnGjt.js");
        return { parser };
