const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-mP-TONu5.js","assets/index-BpkrUGXl.js","assets/index-B6ihXlRp.js","assets/index-CwB2UjhF.js","assets/index-DcADz3ct.js","assets/index-CKUFt-ql.js","assets/index-T7wJ6uwS.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B6ihXlRp.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mP-TONu5.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CwB2UjhF.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DcADz3ct.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CKUFt-ql.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-T7wJ6uwS.js");
        return { parser };
