const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CQHbFvsj.js","assets/index-hpIH1hhT.js","assets/index-R_aOVpBm.js","assets/index-D2TiTuTw.js","assets/index-BOLgDmj2.js","assets/index-DiWOecFh.js","assets/index-Cisw15Zf.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-R_aOVpBm.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQHbFvsj.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D2TiTuTw.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BOLgDmj2.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DiWOecFh.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cisw15Zf.js");
        return { parser };
