const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C8dcibGk.js","assets/index-Wjp3YBx-.js","assets/index-D4RF9JwU.js","assets/index-De6d9ddu.js","assets/index-C0cci4dY.js","assets/index-_JbF8Vyg.js","assets/index-cr9CCBte.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-D4RF9JwU.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C8dcibGk.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-De6d9ddu.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C0cci4dY.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-_JbF8Vyg.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-cr9CCBte.js");
        return { parser };
