const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BV8TYhGz.js","assets/index-D8e-MpH1.js","assets/index-SD-xwlU6.js","assets/index-pXKGA2WW.js","assets/index-Dg5TNzhl.js","assets/index-DEM7_Ye_.js","assets/index-CmIfhSmm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-SD-xwlU6.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BV8TYhGz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-pXKGA2WW.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dg5TNzhl.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DEM7_Ye_.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CmIfhSmm.js");
        return { parser };
