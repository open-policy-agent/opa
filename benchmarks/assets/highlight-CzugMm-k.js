const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-hm7gjVOw.js","assets/index-DN7gY9-D.js","assets/index-C1peIxlK.js","assets/index-vgWM0aIS.js","assets/index-0zvo8YAX.js","assets/index-CJekDCIN.js","assets/index-I0uOR9hm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C1peIxlK.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-hm7gjVOw.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-vgWM0aIS.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-0zvo8YAX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CJekDCIN.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-I0uOR9hm.js");
        return { parser };
