const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CNYG4nz_.js","assets/index-DjTKWhFq.js","assets/index-Bc4O9toY.js","assets/index-BhqpRbVI.js","assets/index-BxNw-a03.js","assets/index-EkORpjqO.js","assets/index-BevqKeU1.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Bc4O9toY.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNYG4nz_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BhqpRbVI.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BxNw-a03.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-EkORpjqO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BevqKeU1.js");
        return { parser };
