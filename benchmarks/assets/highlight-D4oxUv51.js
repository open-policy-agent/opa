const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CpE3KJ_4.js","assets/index-7yjY9-7N.js","assets/index-BRBHum0N.js","assets/index-nhwZAjpo.js","assets/index-D9BNbVxf.js","assets/index-BvKXe-FE.js","assets/index-JfJnsvLk.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BRBHum0N.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CpE3KJ_4.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-nhwZAjpo.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9BNbVxf.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BvKXe-FE.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-JfJnsvLk.js");
        return { parser };
