...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-COH_gm1u.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-DFibPJ7R.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-RBZjncMg.json", import.meta.url).href).json();
    },
