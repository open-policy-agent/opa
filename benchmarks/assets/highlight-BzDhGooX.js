const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DECIVpU0.js","assets/index-Bz6bhQKZ.js","assets/index-C9_25ieH.js","assets/index-CAwmikzi.js","assets/index-CFjS1Y8R.js","assets/index-vyiNCHpK.js","assets/index-5SQTF4aB.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C9_25ieH.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DECIVpU0.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAwmikzi.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CFjS1Y8R.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-vyiNCHpK.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5SQTF4aB.js");
        return { parser };
