const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DavWB4kw.js","assets/index-CjnQlUiQ.js","assets/index-BJBjvrv7.js","assets/index-DZUSldo8.js","assets/index-C4Gb1hw0.js","assets/index-BUmY3kCB.js","assets/index-DZV9mxx_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BJBjvrv7.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DavWB4kw.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZUSldo8.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C4Gb1hw0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BUmY3kCB.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZV9mxx_.js");
        return { parser };
