const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-r-FW7rRz.js","assets/index-BPbzWHqF.js","assets/index-DzjMYzFi.js","assets/index-yGNOjCLV.js","assets/index-BAdaxxeD.js","assets/index-DyI8W_Nv.js","assets/index-ZPYadH8t.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DzjMYzFi.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-r-FW7rRz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yGNOjCLV.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BAdaxxeD.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DyI8W_Nv.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ZPYadH8t.js");
        return { parser };
