const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D37CGNBA.js","assets/index-DAR1O51d.js","assets/index-3g-JGirI.js","assets/index-C4G0PDkt.js","assets/index-CGR_l2mS.js","assets/index-FZ8vZirX.js","assets/index-BfseN-TE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-3g-JGirI.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D37CGNBA.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C4G0PDkt.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGR_l2mS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-FZ8vZirX.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BfseN-TE.js");
        return { parser };
