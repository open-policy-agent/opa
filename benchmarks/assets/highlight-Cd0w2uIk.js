const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bc9SPPJU.js","assets/index-DxPNxlwJ.js","assets/index-C_m-Vdn6.js","assets/index-CfEcLtEU.js","assets/index-C2uTzBIf.js","assets/index-CGaAF26A.js","assets/index-Sw1xxwO-.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C_m-Vdn6.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bc9SPPJU.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CfEcLtEU.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C2uTzBIf.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGaAF26A.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Sw1xxwO-.js");
        return { parser };
