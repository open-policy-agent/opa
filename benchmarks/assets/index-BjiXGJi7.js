...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-B4UU0-MM.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-CJlN5ltN.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-Du-Z-XF5.json", import.meta.url).href).json();
    },
