const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-cxV-KTZC.js","assets/index-CYA-4Fsj.js","assets/index-D88ie3rR.js","assets/index-CROJH58f.js","assets/index-m8onPKID.js","assets/index-D_ijaNBJ.js","assets/index-DlJwfr2t.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-D88ie3rR.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-cxV-KTZC.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CROJH58f.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-m8onPKID.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D_ijaNBJ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DlJwfr2t.js");
        return { parser };
