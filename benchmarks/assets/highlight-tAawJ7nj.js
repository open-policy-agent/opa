const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CY7Z6Yo5.js","assets/index-BwJbPyZo.js","assets/index-B3gGYDwu.js","assets/index-DCMZdiY_.js","assets/index-Cc_De2as.js","assets/index-BAf3CRry.js","assets/index-BZ6q1Yms.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B3gGYDwu.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CY7Z6Yo5.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCMZdiY_.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cc_De2as.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BAf3CRry.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BZ6q1Yms.js");
        return { parser };
