const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bm8-uR0x.js","assets/index-UOdwGEgD.js","assets/index-Drpy9UJd.js","assets/index-DqDJzZTJ.js","assets/index-BFe31ZKS.js","assets/index-CZTKjRNY.js","assets/index-CTECpUhv.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Drpy9UJd.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bm8-uR0x.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DqDJzZTJ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BFe31ZKS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZTKjRNY.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CTECpUhv.js");
        return { parser };
