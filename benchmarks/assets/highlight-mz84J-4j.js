const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DeMr0gxu.js","assets/index-Df4Axlcx.js","assets/index-Db64IJ1K.js","assets/index-VC8sjpfy.js","assets/index-COUF8pkE.js","assets/index-DA1ygjNX.js","assets/index-CNddzoj2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Db64IJ1K.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DeMr0gxu.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-VC8sjpfy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-COUF8pkE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DA1ygjNX.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNddzoj2.js");
        return { parser };
