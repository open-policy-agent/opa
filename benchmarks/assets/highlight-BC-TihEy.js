const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dc1wJS-H.js","assets/index-d5BQ-8uR.js","assets/index-DKVxmju3.js","assets/index-CWFvBkTg.js","assets/index-DjN8mTsX.js","assets/index-CfZZkOiQ.js","assets/index-Cq0FEFMV.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DKVxmju3.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dc1wJS-H.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CWFvBkTg.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DjN8mTsX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CfZZkOiQ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cq0FEFMV.js");
        return { parser };
