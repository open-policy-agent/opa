...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-DGBm93G-.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-BZB0eTDG.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-Dbp99Egz.json", import.meta.url).href).json();
    },
