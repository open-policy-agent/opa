const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CsXEP-l4.js","assets/index-By4gW1wT.js","assets/index-DkqDC_Tr.js","assets/index-BZiq3Hsk.js","assets/index-DtxZwGU6.js","assets/index-DOUkmSCJ.js","assets/index-BX0gUTZ4.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DkqDC_Tr.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CsXEP-l4.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BZiq3Hsk.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DtxZwGU6.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DOUkmSCJ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BX0gUTZ4.js");
        return { parser };
