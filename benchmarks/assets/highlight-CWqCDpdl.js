const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-A7HsWFCE.js","assets/index-DGm3VzG1.js","assets/index-CMWB48vN.js","assets/index-BuePBGeF.js","assets/index-C7j5d55_.js","assets/index-AcZt1RWn.js","assets/index-6sX38XSt.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CMWB48vN.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-A7HsWFCE.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BuePBGeF.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C7j5d55_.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-AcZt1RWn.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-6sX38XSt.js");
        return { parser };
