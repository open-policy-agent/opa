...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-C2Lp0pZZ.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-CI7s5Rfa.js"), true ? [] : void 0).then((_2) => _2.md);
