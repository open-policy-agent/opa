const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B5_jZ06h.js","assets/index-h-RE4vb4.js","assets/index-jM5IG4Et.js","assets/index-1zNWkL4d.js","assets/index-sHWW8jIg.js","assets/index-DbZRwx6f.js","assets/index-QiFwbaKb.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-jM5IG4Et.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B5_jZ06h.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-1zNWkL4d.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-sHWW8jIg.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DbZRwx6f.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-QiFwbaKb.js");
        return { parser };
