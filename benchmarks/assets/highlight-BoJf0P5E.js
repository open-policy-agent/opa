const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CgEeFMAn.js","assets/index-CUDy8tOQ.js","assets/index-BQPV4UEc.js","assets/index-9-8L-f-9.js","assets/index-BJepBgG0.js","assets/index-CSa1XGMh.js","assets/index-Bl5hK3xO.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BQPV4UEc.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CgEeFMAn.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-9-8L-f-9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BJepBgG0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSa1XGMh.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bl5hK3xO.js");
        return { parser };
