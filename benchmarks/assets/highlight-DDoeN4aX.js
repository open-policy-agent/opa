const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BU7b7Xp_.js","assets/index-CbUOVcNU.js","assets/index-Dl1EzDF1.js","assets/index-6R2Qj3tr.js","assets/index-DYObqbVV.js","assets/index-CIPq3bhW.js","assets/index-Cuefya9P.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Dl1EzDF1.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BU7b7Xp_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-6R2Qj3tr.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DYObqbVV.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CIPq3bhW.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cuefya9P.js");
        return { parser };
