const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bth1zyoB.js","assets/index-DM0gtphL.js","assets/index-BI5fffEt.js","assets/index-Df_TPT9J.js","assets/index-D0RR2pBL.js","assets/index-2UnWNTQk.js","assets/index-CBIAOXBp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BI5fffEt.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bth1zyoB.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Df_TPT9J.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D0RR2pBL.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-2UnWNTQk.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CBIAOXBp.js");
        return { parser };
