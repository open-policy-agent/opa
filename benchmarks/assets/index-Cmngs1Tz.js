...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-BHR6jjCl.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-DDUCoJci.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-c0EqATWe.json", import.meta.url).href).json();
    },
