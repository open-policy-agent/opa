const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Baria0NF.js","assets/index-D2zQJbpE.js","assets/index-B7BZH9yi.js","assets/index-CVEpUKDr.js","assets/index-B2g1WX0v.js","assets/index-BrXQ_bi2.js","assets/index-clwxEaoM.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B7BZH9yi.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Baria0NF.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CVEpUKDr.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B2g1WX0v.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BrXQ_bi2.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-clwxEaoM.js");
        return { parser };
