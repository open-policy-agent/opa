const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-3Nkn8TE2.js","assets/index-Cr5ygob5.js","assets/index-CKy2qVs9.js","assets/index-4PaaljTH.js","assets/index-BTwI28jC.js","assets/index-jpcJygbF.js","assets/index-CnYK4xgx.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CKy2qVs9.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3Nkn8TE2.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-4PaaljTH.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BTwI28jC.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-jpcJygbF.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CnYK4xgx.js");
        return { parser };
