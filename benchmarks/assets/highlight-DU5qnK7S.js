const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DPaa-eWe.js","assets/index-CT72dV1Z.js","assets/index-BOi8k6hd.js","assets/index-CarpKg3P.js","assets/index-C87qjVlF.js","assets/index-CgYE2e72.js","assets/index-BKw0k7M9.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BOi8k6hd.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DPaa-eWe.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CarpKg3P.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C87qjVlF.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CgYE2e72.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BKw0k7M9.js");
        return { parser };
