const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DHIAmmFS.js","assets/index-C50RjYiG.js","assets/index-B6lMQo2h.js","assets/index-KIZkpyW3.js","assets/index-BY3fXIGG.js","assets/index-C3VdzvWM.js","assets/index-DwBpSRaE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B6lMQo2h.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHIAmmFS.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-KIZkpyW3.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BY3fXIGG.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C3VdzvWM.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DwBpSRaE.js");
        return { parser };
