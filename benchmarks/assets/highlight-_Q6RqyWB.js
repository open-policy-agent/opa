const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D5YwKvZ3.js","assets/index-DxcCHHlq.js","assets/index-tsCQA4rA.js","assets/index-CNLaPiD5.js","assets/index-BZOI5lxb.js","assets/index-C5DHIE_M.js","assets/index-CSM5HJwQ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-tsCQA4rA.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D5YwKvZ3.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNLaPiD5.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BZOI5lxb.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5DHIE_M.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSM5HJwQ.js");
        return { parser };
