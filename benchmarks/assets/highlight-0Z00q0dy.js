const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BF7DkPn1.js","assets/index-BHeWKi-h.js","assets/index-HpXrJWyf.js","assets/index-CJ4yWsN4.js","assets/index-DKuJWsrC.js","assets/index-LF1VDySA.js","assets/index-B6es2k4o.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-HpXrJWyf.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BF7DkPn1.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CJ4yWsN4.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DKuJWsrC.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-LF1VDySA.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B6es2k4o.js");
        return { parser };
