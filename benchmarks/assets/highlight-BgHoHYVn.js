const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-XruRcxr1.js","assets/index-CXr93Ibw.js","assets/index-DX-ADlyE.js","assets/index-Bzx1YuJV.js","assets/index-BK-4O445.js","assets/index-DcPzkGbj.js","assets/index-CmV0W-we.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DX-ADlyE.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XruRcxr1.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bzx1YuJV.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BK-4O445.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DcPzkGbj.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CmV0W-we.js");
        return { parser };
