const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-bjFOdDJT.js","assets/index-DpVraTjN.js","assets/index-ERFwJZ3i.js","assets/index-AIFn2k_9.js","assets/index-B-tx0sr9.js","assets/index-BzbsNb4v.js","assets/index-rDp7gtq3.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ERFwJZ3i.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-bjFOdDJT.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-AIFn2k_9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B-tx0sr9.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BzbsNb4v.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-rDp7gtq3.js");
        return { parser };
