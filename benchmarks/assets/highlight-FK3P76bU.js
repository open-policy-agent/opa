const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DhReEygB.js","assets/index-BBvGuOD5.js","assets/index-BjiXGJi7.js","assets/index-YT00Wph7.js","assets/index-iHuzvhPV.js","assets/index-Dgi1EpoD.js","assets/index-5v0aSoWi.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BjiXGJi7.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DhReEygB.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-YT00Wph7.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-iHuzvhPV.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dgi1EpoD.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5v0aSoWi.js");
        return { parser };
