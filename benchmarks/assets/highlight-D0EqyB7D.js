const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CnV9CWKf.js","assets/index-BD7EvDOv.js","assets/index-COyK0D71.js","assets/index-lHOxAkji.js","assets/index-Dm51yIVM.js","assets/index-BKYX_w0M.js","assets/index-BjFMKMIA.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-COyK0D71.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CnV9CWKf.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-lHOxAkji.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dm51yIVM.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BKYX_w0M.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BjFMKMIA.js");
        return { parser };
