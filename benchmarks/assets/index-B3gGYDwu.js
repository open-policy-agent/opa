...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-CsY2tSrO.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-Bkbio2gX.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-n2Am-_MH.json", import.meta.url).href).json();
    },
