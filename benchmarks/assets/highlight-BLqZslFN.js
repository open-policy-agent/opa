const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Df-ze57N.js","assets/index-5sgRZ5pd.js","assets/index-DNsKgQUf.js","assets/index-BT5Kg6U3.js","assets/index-Cr6KB5OA.js","assets/index-3JPDSd8b.js","assets/index-C5cq_1Ut.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DNsKgQUf.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Df-ze57N.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BT5Kg6U3.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cr6KB5OA.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-3JPDSd8b.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5cq_1Ut.js");
        return { parser };
