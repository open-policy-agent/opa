const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CkQsdkao.js","assets/index-DYUc0SGW.js","assets/index-DCmE7U7n.js","assets/index-BFFjpVTU.js","assets/index-BnsewioG.js","assets/index-DYfl7Zfu.js","assets/index-C7SM26g9.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DCmE7U7n.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CkQsdkao.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BFFjpVTU.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BnsewioG.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DYfl7Zfu.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C7SM26g9.js");
        return { parser };
