const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CmeQe7Jl.js","assets/index-CEXGncvF.js","assets/index-CItMpgjQ.js","assets/index-Co4Lhtzs.js","assets/index-L2TAjZkS.js","assets/index-B3BfBt4G.js","assets/index-SW5oWUzP.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CItMpgjQ.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CmeQe7Jl.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Co4Lhtzs.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-L2TAjZkS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3BfBt4G.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SW5oWUzP.js");
        return { parser };
