const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BkDFuFUw.js","assets/index-8qFTXDmN.js","assets/index-4W6-Byvh.js","assets/index-D9Xl0nZH.js","assets/index-BeIfmkYl.js","assets/index-BTFpRZ3q.js","assets/index-DvuMKIk1.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-4W6-Byvh.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BkDFuFUw.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9Xl0nZH.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BeIfmkYl.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BTFpRZ3q.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DvuMKIk1.js");
        return { parser };
