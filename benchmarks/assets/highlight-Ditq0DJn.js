const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-5QoqeFkR.js","assets/index-BT-wSA1C.js","assets/index-DSZV_jDm.js","assets/index-DqTiT5CK.js","assets/index-D345-k1T.js","assets/index-Blg68VtC.js","assets/index-D4k0ktpd.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DSZV_jDm.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5QoqeFkR.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DqTiT5CK.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D345-k1T.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Blg68VtC.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D4k0ktpd.js");
        return { parser };
