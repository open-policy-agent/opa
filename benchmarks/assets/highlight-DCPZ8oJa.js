const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BzpFM9nn.js","assets/index-CnUDunNR.js","assets/index-p0foybBf.js","assets/index-0YYJgzY9.js","assets/index-Chqe7lbg.js","assets/index-BtOpN7wS.js","assets/index-CZDmkJDo.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-p0foybBf.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BzpFM9nn.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-0YYJgzY9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Chqe7lbg.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BtOpN7wS.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZDmkJDo.js");
        return { parser };
