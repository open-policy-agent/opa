const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D8tvVRUT.js","assets/index-CRAZLOJT.js","assets/index-CpSVGlfW.js","assets/index-DYSY-RUV.js","assets/index-BYZ9Jbip.js","assets/index-e-0J_m3Y.js","assets/index-lznuDp1u.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CpSVGlfW.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D8tvVRUT.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DYSY-RUV.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BYZ9Jbip.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-e-0J_m3Y.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-lznuDp1u.js");
        return { parser };
