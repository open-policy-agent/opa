const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-V9SSwzQ1.js","assets/index-DO4gDXte.js","assets/index-0c9ubpYo.js","assets/index-C41RQ56Z.js","assets/index-ruXu0FkT.js","assets/index-x5C8bXSO.js","assets/index-Ccn6Ut5a.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-0c9ubpYo.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-V9SSwzQ1.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C41RQ56Z.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ruXu0FkT.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-x5C8bXSO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ccn6Ut5a.js");
        return { parser };
