const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-G19sFahd.js","assets/index-DC1Fj-J0.js","assets/index-DugwKzHC.js","assets/index-slTR6_Wx.js","assets/index-BA2w-E5Z.js","assets/index-DDbRhN-W.js","assets/index-c2L0lXnX.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DugwKzHC.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-G19sFahd.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-slTR6_Wx.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BA2w-E5Z.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DDbRhN-W.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-c2L0lXnX.js");
        return { parser };
