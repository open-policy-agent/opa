...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-BO3VfcXo.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-ufO9sDWu.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-DkW6etyz.json", import.meta.url).href).json();
    },
