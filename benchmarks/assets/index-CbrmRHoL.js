...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-B2xlWgyh.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-1D5Y39V3.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-DElhFyFS.json", import.meta.url).href).json();
    },
