const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CFT6q_dX.js","assets/index-Cs9kGf-L.js","assets/index-CRsxBP-T.js","assets/index-CSQEhL2N.js","assets/index-amqOo8tC.js","assets/index-Bl7-m7RA.js","assets/index-B3w3ISqe.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CRsxBP-T.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CFT6q_dX.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CSQEhL2N.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-amqOo8tC.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bl7-m7RA.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3w3ISqe.js");
        return { parser };
