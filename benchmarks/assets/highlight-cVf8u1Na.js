const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BMaWRCsF.js","assets/index-CB4qJFwf.js","assets/index-B1WX1edk.js","assets/index-Ds7TKqbf.js","assets/index-DbQVhTao.js","assets/index-DwG8v8_S.js","assets/index-CMcXbNIL.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B1WX1edk.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BMaWRCsF.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ds7TKqbf.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DbQVhTao.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DwG8v8_S.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CMcXbNIL.js");
        return { parser };
