const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D-l9Mg_C.js","assets/index-Dthp0wcl.js","assets/index-DR2VLFGD.js","assets/index-CHNOCgNd.js","assets/index-AuLEABoE.js","assets/index-NfZ4YZUk.js","assets/index-D4Qr1e50.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DR2VLFGD.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-l9Mg_C.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CHNOCgNd.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-AuLEABoE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-NfZ4YZUk.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D4Qr1e50.js");
        return { parser };
