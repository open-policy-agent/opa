const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DeGdWrUv.js","assets/index-Z2uC0xEb.js","assets/index-CIcGXK8l.js","assets/index-DSB5VQ9I.js","assets/index-IIw7q8yX.js","assets/index-C5UftKF8.js","assets/index-D76EMN4q.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CIcGXK8l.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DeGdWrUv.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSB5VQ9I.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-IIw7q8yX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5UftKF8.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D76EMN4q.js");
        return { parser };
