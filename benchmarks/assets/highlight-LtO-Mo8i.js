const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BynMPrmq.js","assets/index-Xm3t2C4J.js","assets/index-BPCHI61k.js","assets/index-BFHJFyqN.js","assets/index-DZigcXS5.js","assets/index-DUTMdTDZ.js","assets/index-BGqf7YYj.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BPCHI61k.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BynMPrmq.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BFHJFyqN.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DZigcXS5.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DUTMdTDZ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BGqf7YYj.js");
        return { parser };
