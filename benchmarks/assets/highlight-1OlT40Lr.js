const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CscWcPR6.js","assets/index-DOo0Ji2B.js","assets/index-CBQ-7BkG.js","assets/index-Cd7iv7kH.js","assets/index-cfrUL0Ey.js","assets/index-C7mcPAYJ.js","assets/index-5M5ZPBH2.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CBQ-7BkG.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CscWcPR6.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cd7iv7kH.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-cfrUL0Ey.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C7mcPAYJ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5M5ZPBH2.js");
        return { parser };
