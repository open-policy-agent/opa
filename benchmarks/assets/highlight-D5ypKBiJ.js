const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dj4hb6Xt.js","assets/index-CJKSpXxJ.js","assets/index-ByLDGVzv.js","assets/index-BEoH9dWy.js","assets/index-Dyu5ANWE.js","assets/index-CYl-Seqp.js","assets/index-BbqpUkbQ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ByLDGVzv.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dj4hb6Xt.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BEoH9dWy.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dyu5ANWE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CYl-Seqp.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BbqpUkbQ.js");
        return { parser };
