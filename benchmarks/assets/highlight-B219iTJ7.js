const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DtuYHJ5Y.js","assets/index-Ds2zeEOt.js","assets/index-Cp3WT-JT.js","assets/index-k6gOwS5b.js","assets/index-frNuNQCR.js","assets/index-C0FTJKeH.js","assets/index-PzMIPFrE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Cp3WT-JT.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DtuYHJ5Y.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-k6gOwS5b.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-frNuNQCR.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C0FTJKeH.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-PzMIPFrE.js");
        return { parser };
