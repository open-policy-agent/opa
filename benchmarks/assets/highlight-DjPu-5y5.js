const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-2up7a8Ga.js","assets/index-D1CdwmNu.js","assets/index-l9yv8tSO.js","assets/index-CGWJkRL5.js","assets/index-ByKNQ6uQ.js","assets/index-CM4Dt7le.js","assets/index-CcfeZaOq.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-l9yv8tSO.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-2up7a8Ga.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGWJkRL5.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ByKNQ6uQ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CM4Dt7le.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CcfeZaOq.js");
        return { parser };
