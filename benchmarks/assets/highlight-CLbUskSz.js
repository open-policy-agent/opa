const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BmOiJg7v.js","assets/index-yGBGiJm2.js","assets/index-CWSYkFJk.js","assets/index-CUd4PoM0.js","assets/index-BlO64FcQ.js","assets/index-DzUvwdPY.js","assets/index-Dtd7IcBH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CWSYkFJk.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BmOiJg7v.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CUd4PoM0.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BlO64FcQ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DzUvwdPY.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dtd7IcBH.js");
        return { parser };
