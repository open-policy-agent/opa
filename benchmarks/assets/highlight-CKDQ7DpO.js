const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BMrqnwK_.js","assets/index-CXxLJqpy.js","assets/index-CE1BKFHl.js","assets/index-mhJ8GfQY.js","assets/index-CimSZR_E.js","assets/index-D9qs7LEZ.js","assets/index-COdcggZ9.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CE1BKFHl.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BMrqnwK_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mhJ8GfQY.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CimSZR_E.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9qs7LEZ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-COdcggZ9.js");
        return { parser };
