const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CG6map59.js","assets/index-1dsyH4BN.js","assets/index-DhTAVCh_.js","assets/index-XnjbaYct.js","assets/index-BSKgPuSf.js","assets/index-BkjjhH-t.js","assets/index-DHTYfm6u.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DhTAVCh_.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CG6map59.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XnjbaYct.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BSKgPuSf.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BkjjhH-t.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DHTYfm6u.js");
        return { parser };
