const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-K-YD3lzA.js","assets/index-D7is8-CT.js","assets/index-CSR9g-6y.js","assets/index-CQtm_K0V.js","assets/index-DCZg_kb_.js","assets/index-D-BJ5CB5.js","assets/index-DB3qTiE_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CSR9g-6y.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-K-YD3lzA.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQtm_K0V.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCZg_kb_.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-BJ5CB5.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DB3qTiE_.js");
        return { parser };
