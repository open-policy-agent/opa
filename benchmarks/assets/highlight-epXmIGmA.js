const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-RLsoVkio.js","assets/index-admKUzWm.js","assets/index-BzExjtJ3.js","assets/index-CyGVM-vk.js","assets/index-DqQlkSw_.js","assets/index-w9GE0xy-.js","assets/index-CDvm9O4R.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BzExjtJ3.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-RLsoVkio.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CyGVM-vk.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DqQlkSw_.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-w9GE0xy-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CDvm9O4R.js");
        return { parser };
