const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BGxFsQlB.js","assets/index-BtHA5Jox.js","assets/index-baDZCuO0.js","assets/index-DMjoMV-9.js","assets/index-BTa61Lr5.js","assets/index-CWLy7BBc.js","assets/index-DtSW5l6v.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-baDZCuO0.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BGxFsQlB.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DMjoMV-9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BTa61Lr5.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CWLy7BBc.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DtSW5l6v.js");
        return { parser };
