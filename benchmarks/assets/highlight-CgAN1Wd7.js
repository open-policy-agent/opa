const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-WoGAVL9f.js","assets/index-Dftv4N4L.js","assets/index-jzTRcES6.js","assets/index-D1QFMx06.js","assets/index-BbYNk8UV.js","assets/index-C2NaoGzx.js","assets/index-VmW9ZGWO.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-jzTRcES6.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-WoGAVL9f.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D1QFMx06.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BbYNk8UV.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C2NaoGzx.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-VmW9ZGWO.js");
        return { parser };
