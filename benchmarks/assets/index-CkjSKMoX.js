...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-DUqKIhpf.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-CHd44-Oe.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    id: 4,
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("data:application/json;base64,", import.meta.url).href).json();
    },
    inputs: ["FileAttachment"],
    outputs: [],
    output: "tags",
