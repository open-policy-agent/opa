const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C9BNTBLF.js","assets/index-Cd0vT-rx.js","assets/index-DVdS2820.js","assets/index-BFrVQoiq.js","assets/index-DYjLzZwD.js","assets/index-CwzyJ9Cg.js","assets/index-DfztE-Jx.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DVdS2820.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C9BNTBLF.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BFrVQoiq.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DYjLzZwD.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CwzyJ9Cg.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DfztE-Jx.js");
        return { parser };
