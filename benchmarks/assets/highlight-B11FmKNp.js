const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DwCcBPO4.js","assets/index-CRZvCOjC.js","assets/index-CrrmSIIx.js","assets/index-DLNmGZrQ.js","assets/index-C5_-C-nA.js","assets/index-DAE_BpC8.js","assets/index-B7nqRBWL.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CrrmSIIx.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DwCcBPO4.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DLNmGZrQ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C5_-C-nA.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DAE_BpC8.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B7nqRBWL.js");
        return { parser };
