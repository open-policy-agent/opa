const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CiGmeRg6.js","assets/index-C-wML7z3.js","assets/index-DdNPINuj.js","assets/index-CZBOLI-9.js","assets/index-Bp4HIRWv.js","assets/index-WQuG3uk6.js","assets/index-BQCmT5Gp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DdNPINuj.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CiGmeRg6.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZBOLI-9.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bp4HIRWv.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-WQuG3uk6.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BQCmT5Gp.js");
        return { parser };
