const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-yJxxfBXl.js","assets/index-Cxv8Ivxz.js","assets/index-TjKCrYPM.js","assets/index-BfWD9EQJ.js","assets/index-Df5ncKpE.js","assets/index-OZXscARt.js","assets/index-DCkVYTCo.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-TjKCrYPM.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yJxxfBXl.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BfWD9EQJ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Df5ncKpE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-OZXscARt.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DCkVYTCo.js");
        return { parser };
