const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-SD98Ybt7.js","assets/index-C7FVeyw6.js","assets/index-B73njmjg.js","assets/index-BUlNZ_Ky.js","assets/index-dkd1N5Q0.js","assets/index-BNCC91B-.js","assets/index-LzP0zl5g.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B73njmjg.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SD98Ybt7.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BUlNZ_Ky.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-dkd1N5Q0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BNCC91B-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-LzP0zl5g.js");
        return { parser };
