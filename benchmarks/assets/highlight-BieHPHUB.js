const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C-CkC_M9.js","assets/index-BYwzciKp.js","assets/index-ABe0QyKA.js","assets/index-B-6D8Vsg.js","assets/index-D9V0t9z2.js","assets/index-BLsoKoJT.js","assets/index-DjNffAbR.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ABe0QyKA.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C-CkC_M9.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B-6D8Vsg.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9V0t9z2.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BLsoKoJT.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DjNffAbR.js");
        return { parser };
