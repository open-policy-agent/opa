const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CIKT-7Yk.js","assets/index-5zgqVobI.js","assets/index-BY1UbIWH.js","assets/index-Cy5zgvsn.js","assets/index-BRFNNb9C.js","assets/index-Dmc9BENO.js","assets/index-B1pfXs02.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BY1UbIWH.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CIKT-7Yk.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cy5zgvsn.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BRFNNb9C.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dmc9BENO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B1pfXs02.js");
        return { parser };
