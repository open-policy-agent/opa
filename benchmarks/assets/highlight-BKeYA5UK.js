const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D-f8S0r9.js","assets/index-Bb1MMfgN.js","assets/index-CrKhhMmh.js","assets/index-CXzpJkYX.js","assets/index-CqGE1ctO.js","assets/index-DBpw6_2r.js","assets/index-BT4EJKsb.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CrKhhMmh.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-f8S0r9.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CXzpJkYX.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CqGE1ctO.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DBpw6_2r.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BT4EJKsb.js");
        return { parser };
