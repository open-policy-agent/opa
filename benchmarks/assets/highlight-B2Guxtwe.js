const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DN57b8kC.js","assets/index-CI_upvZ3.js","assets/index-CrgvRfLr.js","assets/index-BAb3OQqX.js","assets/index-CQSvwd6o.js","assets/index-Cux24SY-.js","assets/index-4yNWo7iE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CrgvRfLr.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DN57b8kC.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BAb3OQqX.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQSvwd6o.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cux24SY-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-4yNWo7iE.js");
        return { parser };
