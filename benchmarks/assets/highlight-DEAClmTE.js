const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-W34kS-Xp.js","assets/index-CDPkM0Uo.js","assets/index-C2w7e1Lj.js","assets/index-B0Xse0Yx.js","assets/index-rEB8JwDu.js","assets/index-mzTL6Cea.js","assets/index-XHlPBc1L.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C2w7e1Lj.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-W34kS-Xp.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B0Xse0Yx.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-rEB8JwDu.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mzTL6Cea.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-XHlPBc1L.js");
        return { parser };
