const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BogmQ5Ai.js","assets/index-BLaZ6Edv.js","assets/index-CVmV4NQW.js","assets/index-Dq-LodVE.js","assets/index-gLvoTOgo.js","assets/index-CLQ3gGTB.js","assets/index-Dw7HuoYS.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CVmV4NQW.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BogmQ5Ai.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dq-LodVE.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-gLvoTOgo.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CLQ3gGTB.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dw7HuoYS.js");
        return { parser };
