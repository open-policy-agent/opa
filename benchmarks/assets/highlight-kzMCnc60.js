const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-X-SymG3l.js","assets/index-DwB5a1k9.js","assets/index-Dji3PN16.js","assets/index-HGOR436_.js","assets/index-qUSGQ4nX.js","assets/index-tbOs97WO.js","assets/index-E7_5VWVE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Dji3PN16.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-X-SymG3l.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-HGOR436_.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-qUSGQ4nX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-tbOs97WO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-E7_5VWVE.js");
        return { parser };
