const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CP1X0Jct.js","assets/index-Dv9HlII-.js","assets/index-CWhWBAU9.js","assets/index-7FZaEL11.js","assets/index-CEUQFw6b.js","assets/index-ByVkho7N.js","assets/index-DSVqwgtI.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CWhWBAU9.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CP1X0Jct.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-7FZaEL11.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CEUQFw6b.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ByVkho7N.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSVqwgtI.js");
        return { parser };
