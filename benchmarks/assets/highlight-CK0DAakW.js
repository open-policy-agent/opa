const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-bscmaPCw.js","assets/index-zCox_kNH.js","assets/index-DaNC1Mvi.js","assets/index-BFKB8u93.js","assets/index-CjGBfPP0.js","assets/index-k__YEkrb.js","assets/index-CbPjHwDc.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DaNC1Mvi.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-bscmaPCw.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BFKB8u93.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CjGBfPP0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-k__YEkrb.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CbPjHwDc.js");
        return { parser };
