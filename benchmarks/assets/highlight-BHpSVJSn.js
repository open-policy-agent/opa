const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DriMKNDk.js","assets/index-CJKIyZ5M.js","assets/index-ByFwDvIq.js","assets/index-BaSPkTIf.js","assets/index-CDMkRKsl.js","assets/index-BRYUF_S_.js","assets/index-DwV138VP.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ByFwDvIq.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DriMKNDk.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BaSPkTIf.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CDMkRKsl.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BRYUF_S_.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DwV138VP.js");
        return { parser };
