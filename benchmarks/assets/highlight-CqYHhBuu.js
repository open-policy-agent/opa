const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Csrq17TE.js","assets/index-Cl3MsSvi.js","assets/index-DxaIenjF.js","assets/index-BUYlSVmo.js","assets/index-wSNc7dto.js","assets/index-n374Nhfp.js","assets/index-Q_l64dxZ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DxaIenjF.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Csrq17TE.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BUYlSVmo.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-wSNc7dto.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-n374Nhfp.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Q_l64dxZ.js");
        return { parser };
