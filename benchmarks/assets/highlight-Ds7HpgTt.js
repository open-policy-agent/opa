const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BXgbJ7AA.js","assets/index-D8ZbtFCx.js","assets/index-B1foGZBG.js","assets/index-miptObRR.js","assets/index-CAVvg1Gd.js","assets/index-Y3EU3Joi.js","assets/index-Cq8IPR_X.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B1foGZBG.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BXgbJ7AA.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-miptObRR.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAVvg1Gd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Y3EU3Joi.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cq8IPR_X.js");
        return { parser };
