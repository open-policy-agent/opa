const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D7tNOBRo.js","assets/index-C1lHsALf.js","assets/index-4w06WM3K.js","assets/index-DuQm2O1E.js","assets/index-B3opD5bb.js","assets/index-eqaz9zuJ.js","assets/index-Cksy0nIN.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-4w06WM3K.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D7tNOBRo.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DuQm2O1E.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3opD5bb.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-eqaz9zuJ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cksy0nIN.js");
        return { parser };
