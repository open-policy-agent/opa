const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B1X9DPXU.js","assets/index-CMi7rcMA.js","assets/index-pk9Wa1He.js","assets/index-CC0dFACv.js","assets/index-DC99CAmz.js","assets/index-BmA1o-Kg.js","assets/index-DsRcfY_S.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-pk9Wa1He.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B1X9DPXU.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CC0dFACv.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DC99CAmz.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BmA1o-Kg.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DsRcfY_S.js");
        return { parser };
