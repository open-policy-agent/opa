const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-MhUIrEGq.js","assets/index-B_hzl8vH.js","assets/index-oWbWA6-C.js","assets/index-adIDrRnG.js","assets/index-Buzc95yX.js","assets/index-DPWXIgpy.js","assets/index-D3u1888U.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-oWbWA6-C.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-MhUIrEGq.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-adIDrRnG.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Buzc95yX.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DPWXIgpy.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D3u1888U.js");
        return { parser };
