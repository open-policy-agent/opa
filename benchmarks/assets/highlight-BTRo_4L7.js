const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-at_Ug5WO.js","assets/index-CTg4TCtI.js","assets/index-DZQtEbWv.js","assets/index-9veXP8Hx.js","assets/index-F4Z8Geq0.js","assets/index-0PAekix-.js","assets/index-DN5KzYda.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DZQtEbWv.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-at_Ug5WO.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-9veXP8Hx.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-F4Z8Geq0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-0PAekix-.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DN5KzYda.js");
        return { parser };
