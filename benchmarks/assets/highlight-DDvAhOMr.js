const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DkDAmewh.js","assets/index-epyqw2Su.js","assets/index-CKSzMP7m.js","assets/index-Bwl8qP3n.js","assets/index-xymkwGuu.js","assets/index-CPYJKKd8.js","assets/index-BwoiLe6_.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CKSzMP7m.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DkDAmewh.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bwl8qP3n.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-xymkwGuu.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CPYJKKd8.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BwoiLe6_.js");
        return { parser };
