...
const DuckDBClient = () => __vitePreload(() => import("./duckdb-BO3MKvG0.js"), true ? [] : void 0).then((_2) => _2.DuckDBClient);
...
const md = () => __vitePreload(() => import("./md-ClaqSmPP.js"), true ? [] : void 0).then((_2) => _2.md);
...
define(
  ...
  },
  {
    ...
    body: (FileAttachment2) => {
      return FileAttachment2(new URL("/opa/benchmarks/assets/node-2sqbms3s85uuh6dw-XXfMG9jT.json", import.meta.url).href).json();
    },
