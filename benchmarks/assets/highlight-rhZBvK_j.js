const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C_yOQT5f.js","assets/index-BZ6pFDaz.js","assets/index-DGc4nfjh.js","assets/index-CZLix3-I.js","assets/index-DJ2_VKTN.js","assets/index-CXCRnwuo.js","assets/index-Bh9ncojV.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DGc4nfjh.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C_yOQT5f.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CZLix3-I.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DJ2_VKTN.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CXCRnwuo.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bh9ncojV.js");
        return { parser };
