const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DM8DU6Oz.js","assets/index-0uMgy9U5.js","assets/index-DNXFTgyP.js","assets/index-yG0YhvEz.js","assets/index-BDPd1w55.js","assets/index-DTIHzset.js","assets/index-DxEdL2Bp.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DNXFTgyP.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DM8DU6Oz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-yG0YhvEz.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BDPd1w55.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DTIHzset.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DxEdL2Bp.js");
        return { parser };
