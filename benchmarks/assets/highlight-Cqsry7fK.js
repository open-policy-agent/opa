const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B3janA6_.js","assets/index-rJeKgj29.js","assets/index-TK9DZX7y.js","assets/index-CgUzIPkv.js","assets/index-CBfjY4sd.js","assets/index-ZVEoM4Jf.js","assets/index-BR0WjMFm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-TK9DZX7y.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3janA6_.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CgUzIPkv.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CBfjY4sd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ZVEoM4Jf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BR0WjMFm.js");
        return { parser };
