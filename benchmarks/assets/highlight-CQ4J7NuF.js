const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ByCsa-nf.js","assets/index-Dc1tz319.js","assets/index-CV35nApk.js","assets/index-DFHWMLHZ.js","assets/index-BzHwDZbM.js","assets/index-2siuFGO6.js","assets/index-cs0fXCLb.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CV35nApk.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ByCsa-nf.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DFHWMLHZ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BzHwDZbM.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-2siuFGO6.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-cs0fXCLb.js");
        return { parser };
