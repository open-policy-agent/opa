const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DtzEyw8l.js","assets/index-BS6CVX6a.js","assets/index-BF-ckRLg.js","assets/index-CyMGktEh.js","assets/index-DQiRblp0.js","assets/index-B8Te01Bh.js","assets/index-CGFP2kOM.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BF-ckRLg.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DtzEyw8l.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CyMGktEh.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DQiRblp0.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B8Te01Bh.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGFP2kOM.js");
        return { parser };
