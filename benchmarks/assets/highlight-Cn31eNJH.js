const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-AgEsWWrW.js","assets/index-piyp46Sz.js","assets/index-C5wLbeSC.js","assets/index-4znS4046.js","assets/index-CGEj6uA5.js","assets/index-DY6N4WxA.js","assets/index-CwG3MOJP.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C5wLbeSC.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-AgEsWWrW.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-4znS4046.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGEj6uA5.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DY6N4WxA.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CwG3MOJP.js");
        return { parser };
