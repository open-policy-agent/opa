const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C1SNL7Tb.js","assets/index-DN3JDX0M.js","assets/index-ChmLNN2H.js","assets/index-CQCjT91f.js","assets/index-eoy9MAXd.js","assets/index-B1j7WKX7.js","assets/index-DOhaBGgz.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ChmLNN2H.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C1SNL7Tb.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CQCjT91f.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-eoy9MAXd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B1j7WKX7.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DOhaBGgz.js");
        return { parser };
