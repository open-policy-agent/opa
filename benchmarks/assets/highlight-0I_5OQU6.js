const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CCM5-sTk.js","assets/index-C7HgiTnq.js","assets/index-C2toQqRz.js","assets/index-dc-J2k-F.js","assets/index-1PeWP69n.js","assets/index-5RZeuQrF.js","assets/index-Btvhcj0m.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C2toQqRz.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CCM5-sTk.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-dc-J2k-F.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-1PeWP69n.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5RZeuQrF.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Btvhcj0m.js");
        return { parser };
