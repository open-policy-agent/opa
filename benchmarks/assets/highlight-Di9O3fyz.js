const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BbfLoLuI.js","assets/index-_MD60Daa.js","assets/index-DxzKrMoA.js","assets/index-DfRQt_iT.js","assets/index-CGH1-OdY.js","assets/index-LC1WUR-d.js","assets/index-B131Jarc.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DxzKrMoA.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BbfLoLuI.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DfRQt_iT.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CGH1-OdY.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-LC1WUR-d.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B131Jarc.js");
        return { parser };
