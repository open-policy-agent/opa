const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DyLJkfAg.js","assets/index-DtpikURf.js","assets/index-DPeulPBr.js","assets/index-UNhdVK5w.js","assets/index-BCBeHeDf.js","assets/index-BuNZEs2Y.js","assets/index-BafixIgI.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DPeulPBr.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DyLJkfAg.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-UNhdVK5w.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BCBeHeDf.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BuNZEs2Y.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BafixIgI.js");
        return { parser };
