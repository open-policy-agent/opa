const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BaQQ8iUf.js","assets/index-Bzsrhsb2.js","assets/index-5xhg58Yp.js","assets/index-CNaHuFGN.js","assets/index-DxT7MHCd.js","assets/index-Cfz7cMbZ.js","assets/index-BWlRZT3j.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-5xhg58Yp.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BaQQ8iUf.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNaHuFGN.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DxT7MHCd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cfz7cMbZ.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BWlRZT3j.js");
        return { parser };
