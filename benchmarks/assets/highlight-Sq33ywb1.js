const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B3rIe_Y5.js","assets/index-H8bCmaFO.js","assets/index-B7qQqrmd.js","assets/index-B-wRTZoI.js","assets/index-RGUfpqmn.js","assets/index-D9pXNvM0.js","assets/index-CbHb18kH.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B7qQqrmd.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B3rIe_Y5.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B-wRTZoI.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-RGUfpqmn.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D9pXNvM0.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CbHb18kH.js");
        return { parser };
