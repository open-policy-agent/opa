const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BqW8hv9R.js","assets/index-B9BaLlB5.js","assets/index-CNyAu9uu.js","assets/index-SQdBYo0H.js","assets/index-DbHC1fD5.js","assets/index-DmUS7OM3.js","assets/index-BeNbI9Me.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CNyAu9uu.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BqW8hv9R.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-SQdBYo0H.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DbHC1fD5.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DmUS7OM3.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BeNbI9Me.js");
        return { parser };
