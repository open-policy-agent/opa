const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Bx7EjY-P.js","assets/index-B1pjhZ8p.js","assets/index-Dridj2y0.js","assets/index-CBNHryM4.js","assets/index-nI2EmOdS.js","assets/index-D_42_L3f.js","assets/index-DmpO0wqQ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-Dridj2y0.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bx7EjY-P.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CBNHryM4.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-nI2EmOdS.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D_42_L3f.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DmpO0wqQ.js");
        return { parser };
