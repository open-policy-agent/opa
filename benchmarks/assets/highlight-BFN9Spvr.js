const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DiTffQ1N.js","assets/index-BeCN-NkD.js","assets/index-BoxR9clL.js","assets/index-py9Z79T-.js","assets/index-DScyoR9u.js","assets/index-CjMlXD7M.js","assets/index-BQU6ABgc.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BoxR9clL.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DiTffQ1N.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-py9Z79T-.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DScyoR9u.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CjMlXD7M.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BQU6ABgc.js");
        return { parser };
