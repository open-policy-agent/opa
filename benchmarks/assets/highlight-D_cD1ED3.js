const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-s1RP7UXK.js","assets/index-DWmU7JDF.js","assets/index-COmqXJAM.js","assets/index-BxFzsCuS.js","assets/index-CHYFmV32.js","assets/index-CWMvxVgO.js","assets/index-Dd3abddO.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-COmqXJAM.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-s1RP7UXK.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BxFzsCuS.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CHYFmV32.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CWMvxVgO.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dd3abddO.js");
        return { parser };
