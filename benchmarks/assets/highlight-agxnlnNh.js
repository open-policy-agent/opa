const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DLx7zUTv.js","assets/index-DAvN4Ui4.js","assets/index-DWr3Lkel.js","assets/index-BPUYF4R1.js","assets/index-CyFpm5nj.js","assets/index-WNNnFpcP.js","assets/index-BCP6YtbZ.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DWr3Lkel.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DLx7zUTv.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BPUYF4R1.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CyFpm5nj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-WNNnFpcP.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BCP6YtbZ.js");
        return { parser };
