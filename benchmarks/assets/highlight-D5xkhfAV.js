const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-jLYmRPRP.js","assets/index-C3Ab-v_h.js","assets/index-BPjGSAje.js","assets/index-DkWb5J9E.js","assets/index-CBaap2O9.js","assets/index-DfBfTa8s.js","assets/index-CevvGQYg.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BPjGSAje.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-jLYmRPRP.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DkWb5J9E.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CBaap2O9.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DfBfTa8s.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CevvGQYg.js");
        return { parser };
