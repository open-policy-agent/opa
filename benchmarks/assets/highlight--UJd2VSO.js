const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Cu6YnjCb.js","assets/index-CooMw4WE.js","assets/index-B4Jt8x-e.js","assets/index-DTIO9YiR.js","assets/index-Bfz8RINd.js","assets/index-4UXpCQOH.js","assets/index-Bf3AHtWs.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B4Jt8x-e.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cu6YnjCb.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DTIO9YiR.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bfz8RINd.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-4UXpCQOH.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bf3AHtWs.js");
        return { parser };
