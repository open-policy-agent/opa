const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BysLTEmN.js","assets/index-DrecMoIF.js","assets/index-ByBKRP3X.js","assets/index-BYpaX7lt.js","assets/index-CAgoA3Lq.js","assets/index-DoJ_ZUEF.js","assets/index-DLCZxD8H.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-ByBKRP3X.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BysLTEmN.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BYpaX7lt.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CAgoA3Lq.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DoJ_ZUEF.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DLCZxD8H.js");
        return { parser };
