const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DnqOZCa4.js","assets/index-DObfayWy.js","assets/index-C9As3Kfr.js","assets/index-DNzRRn-7.js","assets/index-DD9j5CoE.js","assets/index-8__7LACr.js","assets/index-D8OuCEK0.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C9As3Kfr.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DnqOZCa4.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DNzRRn-7.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DD9j5CoE.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-8__7LACr.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D8OuCEK0.js");
        return { parser };
