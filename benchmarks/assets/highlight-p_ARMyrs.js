const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BeoxJCLS.js","assets/index-Dts3bvpz.js","assets/index-BaJAEE05.js","assets/index-CvipSJWL.js","assets/index-DLCzu5hj.js","assets/index-CaW_vTG6.js","assets/index-A_hh9bKU.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BaJAEE05.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BeoxJCLS.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CvipSJWL.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DLCzu5hj.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CaW_vTG6.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-A_hh9bKU.js");
        return { parser };
