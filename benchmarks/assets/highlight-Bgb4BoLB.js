const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-mqTrrJT6.js","assets/index-DFV9dOEo.js","assets/index-BJE8zZPY.js","assets/index-B5-XgOvD.js","assets/index-YSXdi-1i.js","assets/index-BUOc7okN.js","assets/index-DEftBT7q.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BJE8zZPY.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-mqTrrJT6.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B5-XgOvD.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-YSXdi-1i.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BUOc7okN.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DEftBT7q.js");
        return { parser };
