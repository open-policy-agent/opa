const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D55Ap9lr.js","assets/index-D_2w8UDs.js","assets/index-CWTfekXa.js","assets/index-MLVcdcm7.js","assets/index-Cjp85uVN.js","assets/index-CoTrETiH.js","assets/index-5oxO4V4D.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-CWTfekXa.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D55Ap9lr.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-MLVcdcm7.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cjp85uVN.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CoTrETiH.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-5oxO4V4D.js");
        return { parser };
