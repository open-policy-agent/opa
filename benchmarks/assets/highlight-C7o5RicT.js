const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dr3QUxNT.js","assets/index-CLPpbBXz.js","assets/index-sLcSbr7B.js","assets/index-DKo4hnRQ.js","assets/index-GcGWDJF9.js","assets/index-BoC4kmXr.js","assets/index-C26nZrV-.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-sLcSbr7B.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dr3QUxNT.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DKo4hnRQ.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-GcGWDJF9.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BoC4kmXr.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C26nZrV-.js");
        return { parser };
