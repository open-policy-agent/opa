const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Cq1FWYlc.js","assets/index-f-c-zNXs.js","assets/index-aqUFjTbK.js","assets/index-ClR7qD3B.js","assets/index-f9HY9hzW.js","assets/index-CKTfokfl.js","assets/index-DipyP-Pt.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-aqUFjTbK.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cq1FWYlc.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ClR7qD3B.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-f9HY9hzW.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CKTfokfl.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DipyP-Pt.js");
        return { parser };
