const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DU1n0dUu.js","assets/index-Biir6Ir9.js","assets/index-zKDnyyjp.js","assets/index-DFJMhD3X.js","assets/index-BHkcv5Ms.js","assets/index-BGZuRyKf.js","assets/index-DOCbomXC.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-zKDnyyjp.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DU1n0dUu.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DFJMhD3X.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BHkcv5Ms.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BGZuRyKf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DOCbomXC.js");
        return { parser };
