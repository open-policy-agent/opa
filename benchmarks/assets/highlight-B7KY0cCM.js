const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CfAyf4Su.js","assets/index-BmtLosz0.js","assets/index-QIVV4t9F.js","assets/index-NXQo1X5o.js","assets/index-R5VQ9sDe.js","assets/index-CizK_Pv1.js","assets/index-ya892I6Y.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-QIVV4t9F.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CfAyf4Su.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-NXQo1X5o.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-R5VQ9sDe.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CizK_Pv1.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-ya892I6Y.js");
        return { parser };
