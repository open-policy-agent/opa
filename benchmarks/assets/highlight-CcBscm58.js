const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DPP0H3gz.js","assets/index-YW0TqWrK.js","assets/index-BvVFyZyD.js","assets/index-sBbdET6J.js","assets/index-BekJq0zM.js","assets/index-D8XgLLgU.js","assets/index-DSYaV54j.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BvVFyZyD.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DPP0H3gz.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-sBbdET6J.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BekJq0zM.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D8XgLLgU.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DSYaV54j.js");
        return { parser };
