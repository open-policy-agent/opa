const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-7b-GS2i-.js","assets/index-qru392J6.js","assets/index-BvP82wUg.js","assets/index-CL8ptnPC.js","assets/index-Ce8MpqwJ.js","assets/index-HT6uOhui.js","assets/index-CwzmidWE.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BvP82wUg.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-7b-GS2i-.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CL8ptnPC.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Ce8MpqwJ.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-HT6uOhui.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CwzmidWE.js");
        return { parser };
