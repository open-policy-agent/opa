const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-qBf5I4dJ.js","assets/index-BFzwO78F.js","assets/index-BeBUF17K.js","assets/index-Bbfg8Mox.js","assets/index-DqS80yPe.js","assets/index-w4O6cQDM.js","assets/index-C9NEirlm.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BeBUF17K.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-qBf5I4dJ.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Bbfg8Mox.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DqS80yPe.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-w4O6cQDM.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C9NEirlm.js");
        return { parser };
