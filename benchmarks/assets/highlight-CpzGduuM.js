const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CxcFOZ6G.js","assets/index-Dcw7XoJZ.js","assets/index-DmPSCFbL.js","assets/index-CNNMfrPN.js","assets/index-T0TjQsan.js","assets/index-D-OPaelU.js","assets/index-C6kUAInk.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DmPSCFbL.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CxcFOZ6G.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CNNMfrPN.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-T0TjQsan.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D-OPaelU.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-C6kUAInk.js");
        return { parser };
