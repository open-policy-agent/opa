const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-qzxZ37U8.js","assets/index-CLiNeRFA.js","assets/index-qVmHsmOB.js","assets/index-CKitpg2L.js","assets/index-Dqetd6eN.js","assets/index-jQmcEvsH.js","assets/index-Dj_5ED9U.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-qVmHsmOB.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-qzxZ37U8.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CKitpg2L.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dqetd6eN.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-jQmcEvsH.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Dj_5ED9U.js");
        return { parser };
