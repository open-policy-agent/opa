const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DG61CLHT.js","assets/index-8bVdgjFG.js","assets/index-B1LDsFig.js","assets/index-D6K9LH0p.js","assets/index-fFgL3ay_.js","assets/index-Cssehpvy.js","assets/index-DuM-ax5e.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-B1LDsFig.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DG61CLHT.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-D6K9LH0p.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-fFgL3ay_.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-Cssehpvy.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-DuM-ax5e.js");
        return { parser };
