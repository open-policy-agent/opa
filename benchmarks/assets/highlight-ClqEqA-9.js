const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CioNLdsY.js","assets/index-5jXb2tPa.js","assets/index-C8uA-X8R.js","assets/index-BfTOHyia.js","assets/index-784DmPC4.js","assets/index-uy1TwTHf.js","assets/index-B485T-6G.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-C8uA-X8R.js";
  ...
  switch (language) {
    ...
    case "jsx":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-CioNLdsY.js");
        return { parser };
      }, true ? __vite__mapDeps([0,1,2]) : void 0)).parser.configure({ dialect: language });
    case "python":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-BfTOHyia.js");
        return { parser };
      }, true ? __vite__mapDeps([3,1,2]) : void 0)).parser;
    case "html":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-784DmPC4.js");
        return { parser };
      }, true ? __vite__mapDeps([4,1,2]) : void 0)).parser;
    case "css":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-uy1TwTHf.js");
        return { parser };
      }, true ? __vite__mapDeps([5,1,2]) : void 0)).parser;
    case "md":
      return (await __vitePreload(async () => {
        const { parser } = await import("./index-B485T-6G.js");
        return { parser };
